...
#define SHADOW_UFCS_PTR_RECV()                                                   \
    ...
    if (shadow_ufcs_emit_arena_meth(meth_name, vty, rb, recv, a,
        ...
        /* Arena / pool / checkpoint table (typed only). */
               ...
               (strcmp(recv, "cc_std_out") == 0 ||
                strcmp(recv, "std_out") == 0)) {
        snprintf(dst, cap, "cc_std_out_write_auto(%s)", a);
    } else if (!is_arrow && strcmp(meth_name, "write") == 0 &&
               (strcmp(recv, "cc_std_err") == 0 ||
                strcmp(recv, "std_err") == 0)) {
        ...
        if (!print_done && !io_handle && (is_cstr || is_lit)) {
            ...
            print_done = 1;
                   ...
                   (strcmp(vty, "CCString") == 0 ||
                    shadow_bind_ty_has(rb, "CCString") ||
                    strstr(recv, "cc_string_") ||
                    strstr(recv, "__cc_tpl") ||

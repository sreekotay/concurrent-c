 ...
 * Factory splices (ArrayMap/Map DECL) seed mangled typedefs into the
 * same table; 64 overflowed once ArrayMap::[K,V] stopped using a
 * compiler-native DECL. 32768 is 4× the old 8192 TU cap. */
enum { SCOPE_CAP = 32, NAME_CAP = 256, AST_CAP = 32768 };

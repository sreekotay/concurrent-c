...
/* By-reference capture (spec §8.11 Captures): every local except arrays.
 * Arrays capture as the decayed element pointer — element writes are
 * already shared, and `&arr` does not type as `T**`. */

...
#define SHADOW_UFCS_PTR_RECV() (ufcs_ptr_recv)
    ...
    /* twice/halve/fabs/strlen: scalar family + bare (system ufn seed). */
        ...
        /* Unknown .len — fail loud. Vec/Map/Pair fall through to Name_meth. */
        return 0;
    ...
    /* Nursery.wait / .cancel: typed CC* invent → cc_nursery_{wait,cancel}. */
        ...
        /* Bodyless `@destroy` equivalence: registered deltas + value embeds
         * first. Unary life / Map / Vec invent only if that chain is empty. */

...
static inline CCString cc_gr_schema_manifest_text(CCArena* a, const char* n, int line,
                                                  ...
                                                  const char* fmtline) {
    return ({ CCArena* __cc_tpl_arena_147 = (a); CCString __cc_tpl_147 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_147, "/* @grammar(schema) ", 20, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (n), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, " (line ", 7, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (line), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, "): ", 3, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (u1), __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (u2), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, ". API:\n *   typedef struct ", 27, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (n), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, " (+ ", 4, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (n), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, "Reader cursor)\n *   cc_parse(", 29, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (n), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, ", s, n, arena, &out)   / ", 25, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (n), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, ".parse(...)  -> ", 16, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (n), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, "_parse\n *   cc_read(", 20, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (n), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, ", s, n, &pos, arena, &out) / ", 29, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (n), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, ".read(...) -> ", 14, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (n), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, "_read\n *   cc_reader(", 21, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (n), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, ", s, n, arena) / ", 17, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (n), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, ".reader(...)        -> ", 23, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (n), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, "_reader\n *   cc_next / cc_at_end / r.next(&out) / r.at_end()    -> ", 67, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (n), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, "Reader_next/_at_end\n *   cc_get(T, &v, \"field\", &out) / v.get(...)          -> T_get + T__fields table\n", 103, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (fmtline), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, " */\n", 4, __cc_tpl_arena_147); __cc_tpl_147; });
}

static inline CCString cc_gr_enum_open_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_148 = (a); CCString __cc_tpl_148 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_148, "typedef enum { ", 15, __cc_tpl_arena_148); __cc_tpl_148; });
}

static inline CCString cc_gr_enum_item_text(CCArena* a, const char* sep,
                                            const char* n, const char* vname) {
    return ({ CCArena* __cc_tpl_arena_149 = (a); CCString __cc_tpl_149 = cc_string_new(); cc__string_slot_push(&__cc_tpl_149, (sep), __cc_tpl_arena_149); cc__string_slot_push(&__cc_tpl_149, (n), __cc_tpl_arena_149); cc_string_push_buffer(&__cc_tpl_149, "_", 1, __cc_tpl_arena_149); cc__string_slot_push(&__cc_tpl_149, (vname), __cc_tpl_arena_149); __cc_tpl_149; });
}

static inline CCString cc_gr_enum_close_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_150 = (a); CCString __cc_tpl_150 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_150, " } ", 3, __cc_tpl_arena_150); cc__string_slot_push(&__cc_tpl_150, (n), __cc_tpl_arena_150); cc_string_push_buffer(&__cc_tpl_150, "Kind;\n", 6, __cc_tpl_arena_150); __cc_tpl_150; });
}

static inline CCString cc_gr_ffc_include_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_151 = (a); CCString __cc_tpl_151 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_151, "#include <ccc/vendor/ffc.h>\n", 28, __cc_tpl_arena_151); __cc_tpl_151; });
}

static inline CCString cc_gr_struct_open_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_152 = (a); CCString __cc_tpl_152 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_152, "typedef struct ", 15, __cc_tpl_arena_152); cc__string_slot_push(&__cc_tpl_152, (n), __cc_tpl_arena_152); cc_string_push_buffer(&__cc_tpl_152, " {\n", 3, __cc_tpl_arena_152); __cc_tpl_152; });
}
...
static inline CCString cc_gr_member_text(CCArena* a, int vk, const char* T,
    ...
    if (vk == 0) return ({ CCArena* __cc_tpl_arena_153 = (a); CCString __cc_tpl_153 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_153, "    long long ", 14, __cc_tpl_arena_153); cc__string_slot_push(&__cc_tpl_153, (field), __cc_tpl_arena_153); cc_string_push_buffer(&__cc_tpl_153, ";\n", 2, __cc_tpl_arena_153); __cc_tpl_153; });
    if (vk == 1) return ({ CCArena* __cc_tpl_arena_154 = (a); CCString __cc_tpl_154 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_154, "    double ", 11, __cc_tpl_arena_154); cc__string_slot_push(&__cc_tpl_154, (field), __cc_tpl_arena_154); cc_string_push_buffer(&__cc_tpl_154, ";\n", 2, __cc_tpl_arena_154); __cc_tpl_154; });
    if (vk == 2) return ({ CCArena* __cc_tpl_arena_155 = (a); CCString __cc_tpl_155 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_155, "    CCSlice ", 12, __cc_tpl_arena_155); cc__string_slot_push(&__cc_tpl_155, (field), __cc_tpl_arena_155); cc_string_push_buffer(&__cc_tpl_155, ";\n", 2, __cc_tpl_arena_155); __cc_tpl_155; });
    if (vk == 3) return ({ CCArena* __cc_tpl_arena_156 = (a); CCString __cc_tpl_156 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_156, "    ", 4, __cc_tpl_arena_156); cc__string_slot_push(&__cc_tpl_156, (T), __cc_tpl_arena_156); cc_string_push_buffer(&__cc_tpl_156, " ", 1, __cc_tpl_arena_156); cc__string_slot_push(&__cc_tpl_156, (field), __cc_tpl_arena_156); cc_string_push_buffer(&__cc_tpl_156, "[", 1, __cc_tpl_arena_156); cc__string_slot_push(&__cc_tpl_156, (cap), __cc_tpl_arena_156); cc_string_push_buffer(&__cc_tpl_156, "]; size_t ", 10, __cc_tpl_arena_156); cc__string_slot_push(&__cc_tpl_156, (field), __cc_tpl_arena_156); cc_string_push_buffer(&__cc_tpl_156, "_n;\n", 4, __cc_tpl_arena_156); __cc_tpl_156; });
    return ({ CCArena* __cc_tpl_arena_157 = (a); CCString __cc_tpl_157 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_157, "    ", 4, __cc_tpl_arena_157); cc__string_slot_push(&__cc_tpl_157, (T), __cc_tpl_arena_157); cc_string_push_buffer(&__cc_tpl_157, "* ", 2, __cc_tpl_arena_157); cc__string_slot_push(&__cc_tpl_157, (field), __cc_tpl_arena_157); cc_string_push_buffer(&__cc_tpl_157, "; size_t ", 9, __cc_tpl_arena_157); cc__string_slot_push(&__cc_tpl_157, (field), __cc_tpl_arena_157); cc_string_push_buffer(&__cc_tpl_157, "_n;\n", 4, __cc_tpl_arena_157); __cc_tpl_157; });
}
...
static inline CCString cc_gr_umember_text(CCArena* a, int vk, const char* T,
                                          const char* field, int cap) {
    if (vk == 0) return ({ CCArena* __cc_tpl_arena_158 = (a); CCString __cc_tpl_158 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_158, "            long long ", 22, __cc_tpl_arena_158); cc__string_slot_push(&__cc_tpl_158, (field), __cc_tpl_arena_158); cc_string_push_buffer(&__cc_tpl_158, ";\n", 2, __cc_tpl_arena_158); __cc_tpl_158; });
    if (vk == 1) return ({ CCArena* __cc_tpl_arena_159 = (a); CCString __cc_tpl_159 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_159, "            double ", 19, __cc_tpl_arena_159); cc__string_slot_push(&__cc_tpl_159, (field), __cc_tpl_arena_159); cc_string_push_buffer(&__cc_tpl_159, ";\n", 2, __cc_tpl_arena_159); __cc_tpl_159; });
    if (vk == 2) return ({ CCArena* __cc_tpl_arena_160 = (a); CCString __cc_tpl_160 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_160, "            CCSlice ", 20, __cc_tpl_arena_160); cc__string_slot_push(&__cc_tpl_160, (field), __cc_tpl_arena_160); cc_string_push_buffer(&__cc_tpl_160, ";\n", 2, __cc_tpl_arena_160); __cc_tpl_160; });
    if (vk == 3) return ({ CCArena* __cc_tpl_arena_161 = (a); CCString __cc_tpl_161 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_161, "            ", 12, __cc_tpl_arena_161); cc__string_slot_push(&__cc_tpl_161, (T), __cc_tpl_arena_161); cc_string_push_buffer(&__cc_tpl_161, " ", 1, __cc_tpl_arena_161); cc__string_slot_push(&__cc_tpl_161, (field), __cc_tpl_arena_161); cc_string_push_buffer(&__cc_tpl_161, "[", 1, __cc_tpl_arena_161); cc__string_slot_push(&__cc_tpl_161, (cap), __cc_tpl_arena_161); cc_string_push_buffer(&__cc_tpl_161, "]; size_t ", 10, __cc_tpl_arena_161); cc__string_slot_push(&__cc_tpl_161, (field), __cc_tpl_arena_161); cc_string_push_buffer(&__cc_tpl_161, "_n;\n", 4, __cc_tpl_arena_161); __cc_tpl_161; });
    return ({ CCArena* __cc_tpl_arena_162 = (a); CCString __cc_tpl_162 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_162, "            struct ", 19, __cc_tpl_arena_162); cc__string_slot_push(&__cc_tpl_162, (T), __cc_tpl_arena_162); cc_string_push_buffer(&__cc_tpl_162, "* ", 2, __cc_tpl_arena_162); cc__string_slot_push(&__cc_tpl_162, (field), __cc_tpl_arena_162); cc_string_push_buffer(&__cc_tpl_162, "; size_t ", 9, __cc_tpl_arena_162); cc__string_slot_push(&__cc_tpl_162, (field), __cc_tpl_arena_162); cc_string_push_buffer(&__cc_tpl_162, "_n;\n", 4, __cc_tpl_arena_162); __cc_tpl_162; });
}

static inline CCString cc_gr_presence_member_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_163 = (a); CCString __cc_tpl_163 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_163, "    unsigned long long cc__set;   /* presence bitmap, bit i = field i */\n", 73, __cc_tpl_arena_163); __cc_tpl_163; });
}

static inline CCString cc_gr_union_decl_open_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_164 = (a); CCString __cc_tpl_164 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_164, "    ", 4, __cc_tpl_arena_164); cc__string_slot_push(&__cc_tpl_164, (n), __cc_tpl_arena_164); cc_string_push_buffer(&__cc_tpl_164, "Kind kind;\n    union {\n", 23, __cc_tpl_arena_164); __cc_tpl_164; });
}

static inline CCString cc_gr_variant_open_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_165 = (a); CCString __cc_tpl_165 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_165, "        struct {\n", 17, __cc_tpl_arena_165); __cc_tpl_165; });
}

static inline CCString cc_gr_variant_close_text(CCArena* a, const char* vname) {
    return ({ CCArena* __cc_tpl_arena_166 = (a); CCString __cc_tpl_166 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_166, "        } ", 10, __cc_tpl_arena_166); cc__string_slot_push(&__cc_tpl_166, (vname), __cc_tpl_arena_166); cc_string_push_buffer(&__cc_tpl_166, ";\n", 2, __cc_tpl_arena_166); __cc_tpl_166; });
}

static inline CCString cc_gr_union_decl_close_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_167 = (a); CCString __cc_tpl_167 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_167, "    } u;\n", 9, __cc_tpl_arena_167); __cc_tpl_167; });
}

static inline CCString cc_gr_empty_member_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_168 = (a); CCString __cc_tpl_168 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_168, "    char cc__empty;\n", 20, __cc_tpl_arena_168); __cc_tpl_168; });
}

static inline CCString cc_gr_struct_close_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_169 = (a); CCString __cc_tpl_169 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_169, "} ", 2, __cc_tpl_arena_169); cc__string_slot_push(&__cc_tpl_169, (n), __cc_tpl_arena_169); cc_string_push_buffer(&__cc_tpl_169, ";\n", 2, __cc_tpl_arena_169); __cc_tpl_169; });
}

static inline CCString cc_gr_fill_head_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_170 = (a); CCString __cc_tpl_170 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_170, "static int ", 11, __cc_tpl_arena_170); cc__string_slot_push(&__cc_tpl_170, (n), __cc_tpl_arena_170); cc_string_push_buffer(&__cc_tpl_170, "__fill(const unsigned char* s, size_t n, size_t* io,\n        CCArena* arena, ", 77, __cc_tpl_arena_170); cc__string_slot_push(&__cc_tpl_170, (n), __cc_tpl_arena_170); cc_string_push_buffer(&__cc_tpl_170, "* out, int* cc_inc, int cc_depth) {\n    (void)cc_inc; (void)cc_depth;\n    size_t p = *io;\n    (void)arena;\n", 107, __cc_tpl_arena_170); __cc_tpl_170; });
}

static inline CCString cc_gr_fill_zero_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_171 = (a); CCString __cc_tpl_171 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_171, "    memset(out, 0, sizeof *out);\n", 33, __cc_tpl_arena_171); __cc_tpl_171; });
}

static inline CCString cc_gr_fill_tail_text(CCArena* a, const char* fail) {
    return ({ CCArena* __cc_tpl_arena_172 = (a); CCString __cc_tpl_172 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_172, "    *io = p;\n    return 1;\n", 27, __cc_tpl_arena_172); cc__string_slot_push(&__cc_tpl_172, (fail), __cc_tpl_arena_172); cc_string_push_buffer(&__cc_tpl_172, ":\n    return 0;\n}\n", 18, __cc_tpl_arena_172); __cc_tpl_172; });
}

static inline CCString cc_gr_parse_fn_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_173 = (a); CCString __cc_tpl_173 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_173, "static int ", 11, __cc_tpl_arena_173); cc__string_slot_push(&__cc_tpl_173, (n), __cc_tpl_arena_173); cc_string_push_buffer(&__cc_tpl_173, "_parse(const char* s0, size_t n, CCArena* arena, ", 49, __cc_tpl_arena_173); cc__string_slot_push(&__cc_tpl_173, (n), __cc_tpl_arena_173); cc_string_push_buffer(&__cc_tpl_173, "* out) {\n    const unsigned char* s = (const unsigned char*)s0;\n    size_t p = 0;\n    { int cc_i0 = 0;\n    if (!", 112, __cc_tpl_arena_173); cc__string_slot_push(&__cc_tpl_173, (n), __cc_tpl_arena_173); cc_string_push_buffer(&__cc_tpl_173, "__fill(s, n, &p, arena, out, &cc_i0, 0)) return 0; }\n    return p == n;\n}\n", 74, __cc_tpl_arena_173); __cc_tpl_173; });
}
...
static inline CCString cc_gr_tostr_fn_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_174 = (a); CCString __cc_tpl_174 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_174, "static __attribute__((unused)) CCString ", 40, __cc_tpl_arena_174); cc__string_slot_push(&__cc_tpl_174, (n), __cc_tpl_arena_174); cc_string_push_buffer(&__cc_tpl_174, "_to_str(const ", 14, __cc_tpl_arena_174); cc__string_slot_push(&__cc_tpl_174, (n), __cc_tpl_arena_174); cc_string_push_buffer(&__cc_tpl_174, "* v, CCArena* arena) {\n    CCString s = cc_string_new();\n    size_t need = ", 75, __cc_tpl_arena_174); cc__string_slot_push(&__cc_tpl_174, (n), __cc_tpl_arena_174); cc_string_push_buffer(&__cc_tpl_174, "__wmeasure(v);\n    char* buf = (char*)cc_arena_alloc_local(arena, need ? need : 1, 1);\n    if (!buf) return s;\n    ", 115, __cc_tpl_arena_174); cc__string_slot_push(&__cc_tpl_174, (n), __cc_tpl_arena_174); cc_string_push_buffer(&__cc_tpl_174, "__wput(v, buf);\n    cc_string_push_buffer(&s, buf, (uint32_t)need, arena);\n    return s;\n}\n", 91, __cc_tpl_arena_174); __cc_tpl_174; });
}

/* ---- rules-tier match entry ---- */
static inline CCString cc_gr_match_entry_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_175 = (a); CCString __cc_tpl_175 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_175, "static int ", 11, __cc_tpl_arena_175); cc__string_slot_push(&__cc_tpl_175, (n), __cc_tpl_arena_175); cc_string_push_buffer(&__cc_tpl_175, "_match(const char* s, size_t n) {\n    size_t p = 0;\n    if (!", 61, __cc_tpl_arena_175); cc__string_slot_push(&__cc_tpl_175, (n), __cc_tpl_arena_175); cc_string_push_buffer(&__cc_tpl_175, "__ENTRY_M((const unsigned char*)s, n, &p)) return 0;\n    return p == n;\n}\n", 74, __cc_tpl_arena_175); __cc_tpl_175; });
}
...
static inline CCString cc_gr_stream_face_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_176 = (a); CCString __cc_tpl_176 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_176, "static bool !>(CCError) ", 24, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "_try_read(const char* s0, size_t n,\n        size_t* pos, CCArena* arena, ", 73, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "* out) {\n    size_t p = *pos;\n    int cc_i0 = 0;\n    if (p >= n) return cc_ok(false);   /* clean end at frame boundary */\n    if (", 130, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "__fill((const unsigned char*)s0, n, &p, arena, out, &cc_i0, 0)) {\n        *pos = p;\n        return cc_ok(true);\n    }\n    if (cc_i0) return cc_err(CC_ERROR(CC_ERR_WOULD_BLOCK, \"", 177, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, ": incomplete frame\"));\n    return cc_err(CC_ERROR(CC_ERR_PARSE, \"", 65, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, ": malformed input\"));\n}\nstatic int ", 35, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "_read(const char* s0, size_t n, size_t* pos, CCArena* arena, ", 61, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "* out) {\n    int cc_i0 = 0;\n    return ", 39, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "__fill((const unsigned char*)s0, n, pos, arena, out, &cc_i0, 0);\n}\ntypedef struct ", 82, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "Reader {\n    const char* s; size_t n; size_t pos; CCArena* arena;\n} ", 68, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "Reader;\nstatic ", 15, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "Reader ", 7, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "_reader(const char* s, size_t n, CCArena* arena) {\n    ", 55, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "Reader r; r.s = s; r.n = n; r.pos = 0; r.arena = arena; return r;\n}\nstatic int ", 79, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "Reader_next(", 12, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "Reader* r, ", 11, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "* out) {\n    if (r->pos >= r->n) return 0;\n    int cc_i0 = 0;\n    return ", 73, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "__fill((const unsigned char*)r->s, r->n, &r->pos, r->arena, out, &cc_i0, 0);\n}\nstatic int ", 90, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "Reader_at_end(const ", 20, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (n), __cc_tpl_arena_176); cc_string_push_buffer(&__cc_tpl_176, "Reader* r) { return r->pos == r->n; }\n", 38, __cc_tpl_arena_176); __cc_tpl_176; });
}

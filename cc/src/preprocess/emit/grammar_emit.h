...
static inline CCString cc_gr_bind_span_inline_close_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_146 = (a); CCString __cc_tpl_146 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_146, "      }\n", 8, __cc_tpl_arena_146); __cc_tpl_146; });
}
...
static inline CCString cc_gr_pad_call_ctx_text(CCArena* a, const char* n, const char* cls,
                                               const char* r, const char* fail) {
    return ({ CCArena* __cc_tpl_arena_147 = (a); CCString __cc_tpl_147 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_147, "    if (!", 9, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (n), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, "__", 2, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (cls), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, "_", 1, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (r), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, "(c, s, n, &p)) goto ", 20, __cc_tpl_arena_147); cc__string_slot_push(&__cc_tpl_147, (fail), __cc_tpl_arena_147); cc_string_push_buffer(&__cc_tpl_147, ";\n", 2, __cc_tpl_arena_147); __cc_tpl_147; });
}
...
static inline CCString cc_gr_schema_manifest_text(CCArena* a, const char* n, int line,
                                                  ...
                                                  const char* fmtline) {
    return ({ CCArena* __cc_tpl_arena_148 = (a); CCString __cc_tpl_148 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_148, "/* @grammar(schema) ", 20, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (n), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, " (line ", 7, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (line), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, "): ", 3, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (u1), __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (u2), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, ". API:\n *   typedef struct ", 27, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (n), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, " (+ ", 4, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (n), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, "Reader cursor)\n *   cc_parse(", 29, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (n), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, ", s, n, arena, &out)   / ", 25, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (n), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, ".parse(...)  -> ", 16, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (n), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, "_parse\n *   cc_read(", 20, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (n), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, ", s, n, &pos, arena, &out) / ", 29, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (n), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, ".read(...) -> ", 14, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (n), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, "_read\n *   cc_reader(", 21, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (n), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, ", s, n, arena) / ", 17, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (n), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, ".reader(...)        -> ", 23, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (n), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, "_reader\n *   cc_next / cc_at_end / r.next(&out) / r.at_end()    -> ", 67, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (n), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, "Reader_next/_at_end\n *   cc_get(T, &v, \"field\", &out) / v.get(...)          -> T_get + T__fields table\n", 103, __cc_tpl_arena_148); cc__string_slot_push(&__cc_tpl_148, (fmtline), __cc_tpl_arena_148); cc_string_push_buffer(&__cc_tpl_148, " */\n", 4, __cc_tpl_arena_148); __cc_tpl_148; });
}

static inline CCString cc_gr_enum_open_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_149 = (a); CCString __cc_tpl_149 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_149, "typedef enum { ", 15, __cc_tpl_arena_149); __cc_tpl_149; });
}

static inline CCString cc_gr_enum_item_text(CCArena* a, const char* sep,
                                            const char* n, const char* vname) {
    return ({ CCArena* __cc_tpl_arena_150 = (a); CCString __cc_tpl_150 = cc_string_new(); cc__string_slot_push(&__cc_tpl_150, (sep), __cc_tpl_arena_150); cc__string_slot_push(&__cc_tpl_150, (n), __cc_tpl_arena_150); cc_string_push_buffer(&__cc_tpl_150, "_", 1, __cc_tpl_arena_150); cc__string_slot_push(&__cc_tpl_150, (vname), __cc_tpl_arena_150); __cc_tpl_150; });
}

static inline CCString cc_gr_enum_close_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_151 = (a); CCString __cc_tpl_151 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_151, " } ", 3, __cc_tpl_arena_151); cc__string_slot_push(&__cc_tpl_151, (n), __cc_tpl_arena_151); cc_string_push_buffer(&__cc_tpl_151, "Kind;\n", 6, __cc_tpl_arena_151); __cc_tpl_151; });
}

static inline CCString cc_gr_ffc_include_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_152 = (a); CCString __cc_tpl_152 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_152, "#include <ccc/vendor/ffc.h>\n", 28, __cc_tpl_arena_152); __cc_tpl_152; });
}

static inline CCString cc_gr_struct_open_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_153 = (a); CCString __cc_tpl_153 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_153, "typedef struct ", 15, __cc_tpl_arena_153); cc__string_slot_push(&__cc_tpl_153, (n), __cc_tpl_arena_153); cc_string_push_buffer(&__cc_tpl_153, " {\n", 3, __cc_tpl_arena_153); __cc_tpl_153; });
}
...
static inline CCString cc_gr_member_text(CCArena* a, int vk, const char* T,
    ...
    if (vk == 0) return ({ CCArena* __cc_tpl_arena_154 = (a); CCString __cc_tpl_154 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_154, "    long long ", 14, __cc_tpl_arena_154); cc__string_slot_push(&__cc_tpl_154, (field), __cc_tpl_arena_154); cc_string_push_buffer(&__cc_tpl_154, ";\n", 2, __cc_tpl_arena_154); __cc_tpl_154; });
    if (vk == 1) return ({ CCArena* __cc_tpl_arena_155 = (a); CCString __cc_tpl_155 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_155, "    double ", 11, __cc_tpl_arena_155); cc__string_slot_push(&__cc_tpl_155, (field), __cc_tpl_arena_155); cc_string_push_buffer(&__cc_tpl_155, ";\n", 2, __cc_tpl_arena_155); __cc_tpl_155; });
    if (vk == 2) return ({ CCArena* __cc_tpl_arena_156 = (a); CCString __cc_tpl_156 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_156, "    CCSlice ", 12, __cc_tpl_arena_156); cc__string_slot_push(&__cc_tpl_156, (field), __cc_tpl_arena_156); cc_string_push_buffer(&__cc_tpl_156, ";\n", 2, __cc_tpl_arena_156); __cc_tpl_156; });
    if (vk == 3) return ({ CCArena* __cc_tpl_arena_157 = (a); CCString __cc_tpl_157 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_157, "    ", 4, __cc_tpl_arena_157); cc__string_slot_push(&__cc_tpl_157, (T), __cc_tpl_arena_157); cc_string_push_buffer(&__cc_tpl_157, " ", 1, __cc_tpl_arena_157); cc__string_slot_push(&__cc_tpl_157, (field), __cc_tpl_arena_157); cc_string_push_buffer(&__cc_tpl_157, "[", 1, __cc_tpl_arena_157); cc__string_slot_push(&__cc_tpl_157, (cap), __cc_tpl_arena_157); cc_string_push_buffer(&__cc_tpl_157, "]; size_t ", 10, __cc_tpl_arena_157); cc__string_slot_push(&__cc_tpl_157, (field), __cc_tpl_arena_157); cc_string_push_buffer(&__cc_tpl_157, "_n;\n", 4, __cc_tpl_arena_157); __cc_tpl_157; });
    return ({ CCArena* __cc_tpl_arena_158 = (a); CCString __cc_tpl_158 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_158, "    ", 4, __cc_tpl_arena_158); cc__string_slot_push(&__cc_tpl_158, (T), __cc_tpl_arena_158); cc_string_push_buffer(&__cc_tpl_158, "* ", 2, __cc_tpl_arena_158); cc__string_slot_push(&__cc_tpl_158, (field), __cc_tpl_arena_158); cc_string_push_buffer(&__cc_tpl_158, "; size_t ", 9, __cc_tpl_arena_158); cc__string_slot_push(&__cc_tpl_158, (field), __cc_tpl_arena_158); cc_string_push_buffer(&__cc_tpl_158, "_n;\n", 4, __cc_tpl_arena_158); __cc_tpl_158; });
}
...
static inline CCString cc_gr_umember_text(CCArena* a, int vk, const char* T,
                                          const char* field, int cap) {
    if (vk == 0) return ({ CCArena* __cc_tpl_arena_159 = (a); CCString __cc_tpl_159 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_159, "            long long ", 22, __cc_tpl_arena_159); cc__string_slot_push(&__cc_tpl_159, (field), __cc_tpl_arena_159); cc_string_push_buffer(&__cc_tpl_159, ";\n", 2, __cc_tpl_arena_159); __cc_tpl_159; });
    if (vk == 1) return ({ CCArena* __cc_tpl_arena_160 = (a); CCString __cc_tpl_160 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_160, "            double ", 19, __cc_tpl_arena_160); cc__string_slot_push(&__cc_tpl_160, (field), __cc_tpl_arena_160); cc_string_push_buffer(&__cc_tpl_160, ";\n", 2, __cc_tpl_arena_160); __cc_tpl_160; });
    if (vk == 2) return ({ CCArena* __cc_tpl_arena_161 = (a); CCString __cc_tpl_161 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_161, "            CCSlice ", 20, __cc_tpl_arena_161); cc__string_slot_push(&__cc_tpl_161, (field), __cc_tpl_arena_161); cc_string_push_buffer(&__cc_tpl_161, ";\n", 2, __cc_tpl_arena_161); __cc_tpl_161; });
    if (vk == 3) return ({ CCArena* __cc_tpl_arena_162 = (a); CCString __cc_tpl_162 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_162, "            ", 12, __cc_tpl_arena_162); cc__string_slot_push(&__cc_tpl_162, (T), __cc_tpl_arena_162); cc_string_push_buffer(&__cc_tpl_162, " ", 1, __cc_tpl_arena_162); cc__string_slot_push(&__cc_tpl_162, (field), __cc_tpl_arena_162); cc_string_push_buffer(&__cc_tpl_162, "[", 1, __cc_tpl_arena_162); cc__string_slot_push(&__cc_tpl_162, (cap), __cc_tpl_arena_162); cc_string_push_buffer(&__cc_tpl_162, "]; size_t ", 10, __cc_tpl_arena_162); cc__string_slot_push(&__cc_tpl_162, (field), __cc_tpl_arena_162); cc_string_push_buffer(&__cc_tpl_162, "_n;\n", 4, __cc_tpl_arena_162); __cc_tpl_162; });
    return ({ CCArena* __cc_tpl_arena_163 = (a); CCString __cc_tpl_163 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_163, "            struct ", 19, __cc_tpl_arena_163); cc__string_slot_push(&__cc_tpl_163, (T), __cc_tpl_arena_163); cc_string_push_buffer(&__cc_tpl_163, "* ", 2, __cc_tpl_arena_163); cc__string_slot_push(&__cc_tpl_163, (field), __cc_tpl_arena_163); cc_string_push_buffer(&__cc_tpl_163, "; size_t ", 9, __cc_tpl_arena_163); cc__string_slot_push(&__cc_tpl_163, (field), __cc_tpl_arena_163); cc_string_push_buffer(&__cc_tpl_163, "_n;\n", 4, __cc_tpl_arena_163); __cc_tpl_163; });
}

static inline CCString cc_gr_presence_member_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_164 = (a); CCString __cc_tpl_164 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_164, "    unsigned long long cc__set;   /* presence bitmap, bit i = field i */\n", 73, __cc_tpl_arena_164); __cc_tpl_164; });
}

static inline CCString cc_gr_union_decl_open_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_165 = (a); CCString __cc_tpl_165 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_165, "    ", 4, __cc_tpl_arena_165); cc__string_slot_push(&__cc_tpl_165, (n), __cc_tpl_arena_165); cc_string_push_buffer(&__cc_tpl_165, "Kind kind;\n    union {\n", 23, __cc_tpl_arena_165); __cc_tpl_165; });
}

static inline CCString cc_gr_variant_open_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_166 = (a); CCString __cc_tpl_166 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_166, "        struct {\n", 17, __cc_tpl_arena_166); __cc_tpl_166; });
}

static inline CCString cc_gr_variant_close_text(CCArena* a, const char* vname) {
    return ({ CCArena* __cc_tpl_arena_167 = (a); CCString __cc_tpl_167 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_167, "        } ", 10, __cc_tpl_arena_167); cc__string_slot_push(&__cc_tpl_167, (vname), __cc_tpl_arena_167); cc_string_push_buffer(&__cc_tpl_167, ";\n", 2, __cc_tpl_arena_167); __cc_tpl_167; });
}

static inline CCString cc_gr_union_decl_close_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_168 = (a); CCString __cc_tpl_168 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_168, "    } u;\n", 9, __cc_tpl_arena_168); __cc_tpl_168; });
}

static inline CCString cc_gr_empty_member_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_169 = (a); CCString __cc_tpl_169 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_169, "    char cc__empty;\n", 20, __cc_tpl_arena_169); __cc_tpl_169; });
}

static inline CCString cc_gr_struct_close_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_170 = (a); CCString __cc_tpl_170 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_170, "} ", 2, __cc_tpl_arena_170); cc__string_slot_push(&__cc_tpl_170, (n), __cc_tpl_arena_170); cc_string_push_buffer(&__cc_tpl_170, ";\n", 2, __cc_tpl_arena_170); __cc_tpl_170; });
}

static inline CCString cc_gr_fill_head_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_171 = (a); CCString __cc_tpl_171 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_171, "static int ", 11, __cc_tpl_arena_171); cc__string_slot_push(&__cc_tpl_171, (n), __cc_tpl_arena_171); cc_string_push_buffer(&__cc_tpl_171, "__fill(const unsigned char* s, size_t n, size_t* io,\n        CCArena* arena, ", 77, __cc_tpl_arena_171); cc__string_slot_push(&__cc_tpl_171, (n), __cc_tpl_arena_171); cc_string_push_buffer(&__cc_tpl_171, "* out, int* cc_inc, int cc_depth) {\n    (void)cc_inc; (void)cc_depth;\n    size_t p = *io;\n    (void)arena;\n", 107, __cc_tpl_arena_171); __cc_tpl_171; });
}

static inline CCString cc_gr_fill_zero_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_172 = (a); CCString __cc_tpl_172 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_172, "    memset(out, 0, sizeof *out);\n", 33, __cc_tpl_arena_172); __cc_tpl_172; });
}

static inline CCString cc_gr_fill_tail_text(CCArena* a, const char* fail) {
    return ({ CCArena* __cc_tpl_arena_173 = (a); CCString __cc_tpl_173 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_173, "    *io = p;\n    return 1;\n", 27, __cc_tpl_arena_173); cc__string_slot_push(&__cc_tpl_173, (fail), __cc_tpl_arena_173); cc_string_push_buffer(&__cc_tpl_173, ":\n    return 0;\n}\n", 18, __cc_tpl_arena_173); __cc_tpl_173; });
}

static inline CCString cc_gr_parse_fn_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_174 = (a); CCString __cc_tpl_174 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_174, "static int ", 11, __cc_tpl_arena_174); cc__string_slot_push(&__cc_tpl_174, (n), __cc_tpl_arena_174); cc_string_push_buffer(&__cc_tpl_174, "_parse(const char* s0, size_t n, CCArena* arena, ", 49, __cc_tpl_arena_174); cc__string_slot_push(&__cc_tpl_174, (n), __cc_tpl_arena_174); cc_string_push_buffer(&__cc_tpl_174, "* out) {\n    const unsigned char* s = (const unsigned char*)s0;\n    size_t p = 0;\n    { int cc_i0 = 0;\n    if (!", 112, __cc_tpl_arena_174); cc__string_slot_push(&__cc_tpl_174, (n), __cc_tpl_arena_174); cc_string_push_buffer(&__cc_tpl_174, "__fill(s, n, &p, arena, out, &cc_i0, 0)) return 0; }\n    return p == n;\n}\n", 74, __cc_tpl_arena_174); __cc_tpl_174; });
}
...
static inline CCString cc_gr_tostr_fn_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_175 = (a); CCString __cc_tpl_175 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_175, "static __attribute__((unused)) CCString ", 40, __cc_tpl_arena_175); cc__string_slot_push(&__cc_tpl_175, (n), __cc_tpl_arena_175); cc_string_push_buffer(&__cc_tpl_175, "_to_str(const ", 14, __cc_tpl_arena_175); cc__string_slot_push(&__cc_tpl_175, (n), __cc_tpl_arena_175); cc_string_push_buffer(&__cc_tpl_175, "* v, CCArena* arena) {\n    CCString s = cc_string_new();\n    size_t need = ", 75, __cc_tpl_arena_175); cc__string_slot_push(&__cc_tpl_175, (n), __cc_tpl_arena_175); cc_string_push_buffer(&__cc_tpl_175, "__wmeasure(v);\n    char* buf = (char*)cc_arena_alloc_local(arena, need ? need : 1, 1);\n    if (!buf) return s;\n    ", 115, __cc_tpl_arena_175); cc__string_slot_push(&__cc_tpl_175, (n), __cc_tpl_arena_175); cc_string_push_buffer(&__cc_tpl_175, "__wput(v, buf);\n    cc_string_push_buffer(&s, buf, (uint32_t)need, arena);\n    return s;\n}\n", 91, __cc_tpl_arena_175); __cc_tpl_175; });
}
...
static inline CCString cc_gr_cse_eq_text(CCArena* a, int lo) {
    return ({ CCArena* __cc_tpl_arena_176 = (a); CCString __cc_tpl_176 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_176, "s[p] == ", 8, __cc_tpl_arena_176); cc__string_slot_push(&__cc_tpl_176, (lo), __cc_tpl_arena_176); __cc_tpl_176; });
}

static inline CCString cc_gr_cse_range_text(CCArena* a, int lo, unsigned int span) {
    return ({ CCArena* __cc_tpl_arena_177 = (a); CCString __cc_tpl_177 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_177, "((unsigned)(s[p] - ", 19, __cc_tpl_arena_177); cc__string_slot_push(&__cc_tpl_177, (lo), __cc_tpl_arena_177); cc_string_push_buffer(&__cc_tpl_177, ") <= ", 5, __cc_tpl_arena_177); cc__string_slot_push(&__cc_tpl_177, (span), __cc_tpl_arena_177); cc_string_push_buffer(&__cc_tpl_177, "u)", 2, __cc_tpl_arena_177); __cc_tpl_177; });
}
...
static inline CCString cc_gr_cse_bytes_text(CCArena* a, int b0, int b1, int b2, int b3, int nb) {
    ...
    if (nb > 1) cc_gr__cat(&o, ({ CCArena* __cc_tpl_arena_178 = (a); CCString __cc_tpl_178 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_178, "(", 1, __cc_tpl_arena_178); __cc_tpl_178; }), a);
    for (int i = 0; i < nb; i++) {
        int b = bs[i];
        if (i) cc_gr__cat(&o, ({ CCArena* __cc_tpl_arena_179 = (a); CCString __cc_tpl_179 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_179, " || ", 4, __cc_tpl_arena_179); __cc_tpl_179; }), a);
        cc_gr__cat(&o, ({ CCArena* __cc_tpl_arena_180 = (a); CCString __cc_tpl_180 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_180, "s[p] == ", 8, __cc_tpl_arena_180); cc__string_slot_push(&__cc_tpl_180, (b), __cc_tpl_arena_180); __cc_tpl_180; }), a);
    }
    if (nb > 1) cc_gr__cat(&o, ({ CCArena* __cc_tpl_arena_181 = (a); CCString __cc_tpl_181 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_181, ")", 1, __cc_tpl_arena_181); __cc_tpl_181; }), a);
    return o;
}

static inline CCString cc_gr_cse_bitset_text(CCArena* a, const char* n, int cs) {
    return ({ CCArena* __cc_tpl_arena_182 = (a); CCString __cc_tpl_182 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_182, "(", 1, __cc_tpl_arena_182); cc__string_slot_push(&__cc_tpl_182, (n), __cc_tpl_arena_182); cc_string_push_buffer(&__cc_tpl_182, "__cs[", 5, __cc_tpl_arena_182); cc__string_slot_push(&__cc_tpl_182, (cs), __cc_tpl_arena_182); cc_string_push_buffer(&__cc_tpl_182, "][((unsigned char)s[p]) >> 3] & (1u << (((unsigned char)s[p]) & 7u)))", 69, __cc_tpl_arena_182); __cc_tpl_182; });
}
...
static inline CCString cc_gr_m_lit1_text(CCArena* a, int b, const char* fail) {
    CCString c = cc_gr_chr_text(a, b);
    return ({ CCArena* __cc_tpl_arena_183 = (a); CCString __cc_tpl_183 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_183, "    if (!(p < n && s[p] == ", 27, __cc_tpl_arena_183); cc__string_slot_push(&__cc_tpl_183, (b), __cc_tpl_arena_183); cc_string_push_buffer(&__cc_tpl_183, " /*", 3, __cc_tpl_arena_183); cc__string_slot_push(&__cc_tpl_183, (c), __cc_tpl_arena_183); cc_string_push_buffer(&__cc_tpl_183, "*/)) goto ", 10, __cc_tpl_arena_183); cc__string_slot_push(&__cc_tpl_183, (fail), __cc_tpl_arena_183); cc_string_push_buffer(&__cc_tpl_183, ";\n    p++;\n", 11, __cc_tpl_arena_183); __cc_tpl_183; });
}
...
static inline CCString cc_gr_m_word_text(CCArena* a, unsigned int w, const unsigned char* bytes,
    ...
    if (len == 4)
        return ({ CCArena* __cc_tpl_arena_184 = (a); CCString __cc_tpl_184 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_184, "    if (!(p + 4 <= n)) goto ", 28, __cc_tpl_arena_184); cc__string_slot_push(&__cc_tpl_184, (fail), __cc_tpl_arena_184); cc_string_push_buffer(&__cc_tpl_184, ";\n    { unsigned int w; memcpy(&w, s + p, 4); if (w != ", 55, __cc_tpl_arena_184); cc__string_slot_push(&__cc_tpl_184, (w), __cc_tpl_arena_184); cc_string_push_buffer(&__cc_tpl_184, "u) goto ", 8, __cc_tpl_arena_184); cc__string_slot_push(&__cc_tpl_184, (fail), __cc_tpl_arena_184); cc_string_push_buffer(&__cc_tpl_184, "; }  /* \"", 9, __cc_tpl_arena_184); cc__string_slot_push(&__cc_tpl_184, (lit), __cc_tpl_arena_184); cc_string_push_buffer(&__cc_tpl_184, "\" */\n    p += 4;\n", 17, __cc_tpl_arena_184); __cc_tpl_184; });
    {
        int b4 = (int)bytes[4];
        return ({ CCArena* __cc_tpl_arena_185 = (a); CCString __cc_tpl_185 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_185, "    if (!(p + 5 <= n)) goto ", 28, __cc_tpl_arena_185); cc__string_slot_push(&__cc_tpl_185, (fail), __cc_tpl_arena_185); cc_string_push_buffer(&__cc_tpl_185, ";\n    { unsigned int w; memcpy(&w, s + p, 4); if (w != ", 55, __cc_tpl_arena_185); cc__string_slot_push(&__cc_tpl_185, (w), __cc_tpl_arena_185); cc_string_push_buffer(&__cc_tpl_185, "u || s[p + 4] != ", 17, __cc_tpl_arena_185); cc__string_slot_push(&__cc_tpl_185, (b4), __cc_tpl_arena_185); cc_string_push_buffer(&__cc_tpl_185, ") goto ", 7, __cc_tpl_arena_185); cc__string_slot_push(&__cc_tpl_185, (fail), __cc_tpl_arena_185); cc_string_push_buffer(&__cc_tpl_185, "; }  /* \"", 9, __cc_tpl_arena_185); cc__string_slot_push(&__cc_tpl_185, (lit), __cc_tpl_arena_185); cc_string_push_buffer(&__cc_tpl_185, "\" */\n    p += 5;\n", 17, __cc_tpl_arena_185); __cc_tpl_185; });
    }
}
...
static inline CCString cc_gr_m_litn_text(CCArena* a, const char* n, int off, int len,
    ...
    CCString lit = cc_gr_esc_text(a, bytes, len);
    return ({ CCArena* __cc_tpl_arena_186 = (a); CCString __cc_tpl_186 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_186, "    if (!(p + ", 14, __cc_tpl_arena_186); cc__string_slot_push(&__cc_tpl_186, (len), __cc_tpl_arena_186); cc_string_push_buffer(&__cc_tpl_186, " <= n && memcmp(s + p, ", 23, __cc_tpl_arena_186); cc__string_slot_push(&__cc_tpl_186, (n), __cc_tpl_arena_186); cc_string_push_buffer(&__cc_tpl_186, "__pool + ", 9, __cc_tpl_arena_186); cc__string_slot_push(&__cc_tpl_186, (off), __cc_tpl_arena_186); cc_string_push_buffer(&__cc_tpl_186, ", ", 2, __cc_tpl_arena_186); cc__string_slot_push(&__cc_tpl_186, (len), __cc_tpl_arena_186); cc_string_push_buffer(&__cc_tpl_186, ") == 0)) goto ", 14, __cc_tpl_arena_186); cc__string_slot_push(&__cc_tpl_186, (fail), __cc_tpl_arena_186); cc_string_push_buffer(&__cc_tpl_186, ";   /* \"", 8, __cc_tpl_arena_186); cc__string_slot_push(&__cc_tpl_186, (lit), __cc_tpl_arena_186); cc_string_push_buffer(&__cc_tpl_186, "\" */\n    p += ", 14, __cc_tpl_arena_186); cc__string_slot_push(&__cc_tpl_186, (len), __cc_tpl_arena_186); cc_string_push_buffer(&__cc_tpl_186, ";\n", 2, __cc_tpl_arena_186); __cc_tpl_186; });
}

static inline CCString cc_gr_m_cs1_text(CCArena* a, CCString cx, const char* fail) {
    return ({ CCArena* __cc_tpl_arena_187 = (a); CCString __cc_tpl_187 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_187, "    if (!(p < n && ", 19, __cc_tpl_arena_187); cc__string_slot_push(&__cc_tpl_187, (cx), __cc_tpl_arena_187); cc_string_push_buffer(&__cc_tpl_187, ")) goto ", 8, __cc_tpl_arena_187); cc__string_slot_push(&__cc_tpl_187, (fail), __cc_tpl_arena_187); cc_string_push_buffer(&__cc_tpl_187, ";\n    p++;\n", 11, __cc_tpl_arena_187); __cc_tpl_187; });
}

static inline CCString cc_gr_m_skip_text(CCArena* a, const char* fail) {
    return ({ CCArena* __cc_tpl_arena_188 = (a); CCString __cc_tpl_188 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_188, "    if (!(p < n)) goto ", 23, __cc_tpl_arena_188); cc__string_slot_push(&__cc_tpl_188, (fail), __cc_tpl_arena_188); cc_string_push_buffer(&__cc_tpl_188, ";\n    p++;\n", 11, __cc_tpl_arena_188); __cc_tpl_188; });
}
...
static inline CCString cc_gr_ref_call_text(CCArena* a, const char* n, const char* cls,
                                           ...
                                           const char* fail) {
    if (with_ctx)
        return ({ CCArena* __cc_tpl_arena_189 = (a); CCString __cc_tpl_189 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_189, "    if (!", 9, __cc_tpl_arena_189); cc__string_slot_push(&__cc_tpl_189, (n), __cc_tpl_arena_189); cc_string_push_buffer(&__cc_tpl_189, "__", 2, __cc_tpl_arena_189); cc__string_slot_push(&__cc_tpl_189, (cls), __cc_tpl_arena_189); cc_string_push_buffer(&__cc_tpl_189, "_", 1, __cc_tpl_arena_189); cc__string_slot_push(&__cc_tpl_189, (r), __cc_tpl_arena_189); cc__string_slot_push(&__cc_tpl_189, (suf), __cc_tpl_arena_189); cc_string_push_buffer(&__cc_tpl_189, "(c, s, n, &p)) goto ", 20, __cc_tpl_arena_189); cc__string_slot_push(&__cc_tpl_189, (fail), __cc_tpl_arena_189); cc_string_push_buffer(&__cc_tpl_189, ";\n", 2, __cc_tpl_arena_189); __cc_tpl_189; });
    return ({ CCArena* __cc_tpl_arena_190 = (a); CCString __cc_tpl_190 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_190, "    if (!", 9, __cc_tpl_arena_190); cc__string_slot_push(&__cc_tpl_190, (n), __cc_tpl_arena_190); cc_string_push_buffer(&__cc_tpl_190, "__", 2, __cc_tpl_arena_190); cc__string_slot_push(&__cc_tpl_190, (cls), __cc_tpl_arena_190); cc_string_push_buffer(&__cc_tpl_190, "_", 1, __cc_tpl_arena_190); cc__string_slot_push(&__cc_tpl_190, (r), __cc_tpl_arena_190); cc__string_slot_push(&__cc_tpl_190, (suf), __cc_tpl_arena_190); cc_string_push_buffer(&__cc_tpl_190, "(s, n, &p)) goto ", 17, __cc_tpl_arena_190); cc__string_slot_push(&__cc_tpl_190, (fail), __cc_tpl_arena_190); cc_string_push_buffer(&__cc_tpl_190, ";\n", 2, __cc_tpl_arena_190); __cc_tpl_190; });
}
...
static inline CCString cc_gr_keep_open_text(CCArena* a, int k, int has_codec) {
    if (has_codec)
        return ({ CCArena* __cc_tpl_arena_191 = (a); CCString __cc_tpl_191 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_191, "    { size_t ka", 15, __cc_tpl_arena_191); cc__string_slot_push(&__cc_tpl_191, (k), __cc_tpl_arena_191); cc_string_push_buffer(&__cc_tpl_191, " = p; int dr", 12, __cc_tpl_arena_191); cc__string_slot_push(&__cc_tpl_191, (k), __cc_tpl_arena_191); cc_string_push_buffer(&__cc_tpl_191, " = 0; (void)dr", 14, __cc_tpl_arena_191); cc__string_slot_push(&__cc_tpl_191, (k), __cc_tpl_arena_191); cc_string_push_buffer(&__cc_tpl_191, ";\n", 2, __cc_tpl_arena_191); __cc_tpl_191; });
    return ({ CCArena* __cc_tpl_arena_192 = (a); CCString __cc_tpl_192 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_192, "    { size_t ka", 15, __cc_tpl_arena_192); cc__string_slot_push(&__cc_tpl_192, (k), __cc_tpl_arena_192); cc_string_push_buffer(&__cc_tpl_192, " = p;\n", 6, __cc_tpl_arena_192); __cc_tpl_192; });
}

static inline CCString cc_gr_keep_x_close_text(CCArena* a, int k, int has_codec) {
    if (has_codec)
        return ({ CCArena* __cc_tpl_arena_193 = (a); CCString __cc_tpl_193 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_193, "    *xa = ka", 12, __cc_tpl_arena_193); cc__string_slot_push(&__cc_tpl_193, (k), __cc_tpl_arena_193); cc_string_push_buffer(&__cc_tpl_193, "; *xb = p; *xdr = dr", 20, __cc_tpl_arena_193); cc__string_slot_push(&__cc_tpl_193, (k), __cc_tpl_arena_193); cc_string_push_buffer(&__cc_tpl_193, ";\n    }\n", 8, __cc_tpl_arena_193); __cc_tpl_193; });
    return ({ CCArena* __cc_tpl_arena_194 = (a); CCString __cc_tpl_194 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_194, "    *xa = ka", 12, __cc_tpl_arena_194); cc__string_slot_push(&__cc_tpl_194, (k), __cc_tpl_arena_194); cc_string_push_buffer(&__cc_tpl_194, "; *xb = p;\n    }\n", 17, __cc_tpl_arena_194); __cc_tpl_194; });
}

static inline CCString cc_gr_tgrow_guard_text(CCArena* a, const char* n, const char* fail) {
    return ({ CCArena* __cc_tpl_arena_195 = (a); CCString __cc_tpl_195 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_195, "    if (c->total == c->cap && !", 31, __cc_tpl_arena_195); cc__string_slot_push(&__cc_tpl_195, (n), __cc_tpl_arena_195); cc_string_push_buffer(&__cc_tpl_195, "__tgrow(c)) goto ", 17, __cc_tpl_arena_195); cc__string_slot_push(&__cc_tpl_195, (fail), __cc_tpl_arena_195); cc_string_push_buffer(&__cc_tpl_195, ";\n", 2, __cc_tpl_arena_195); __cc_tpl_195; });
}

static inline CCString cc_gr_keep_tape_text(CCArena* a, const char* n, int k, int rid) {
    return ({ CCArena* __cc_tpl_arena_196 = (a); CCString __cc_tpl_196 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_196, "    { ", 6, __cc_tpl_arena_196); cc__string_slot_push(&__cc_tpl_196, (n), __cc_tpl_arena_196); cc_string_push_buffer(&__cc_tpl_196, "Node* nd", 8, __cc_tpl_arena_196); cc__string_slot_push(&__cc_tpl_196, (k), __cc_tpl_arena_196); cc_string_push_buffer(&__cc_tpl_196, " = &c->tape[c->total++];\n      nd", 33, __cc_tpl_arena_196); cc__string_slot_push(&__cc_tpl_196, (k), __cc_tpl_arena_196); cc_string_push_buffer(&__cc_tpl_196, "->meta = ", 9, __cc_tpl_arena_196); cc__string_slot_push(&__cc_tpl_196, (rid), __cc_tpl_arena_196); cc_string_push_buffer(&__cc_tpl_196, "u | (((unsigned long long)(p - ka", 33, __cc_tpl_arena_196); cc__string_slot_push(&__cc_tpl_196, (k), __cc_tpl_arena_196); cc_string_push_buffer(&__cc_tpl_196, ")) << 10);\n      nd", 19, __cc_tpl_arena_196); cc__string_slot_push(&__cc_tpl_196, (k), __cc_tpl_arena_196); cc_string_push_buffer(&__cc_tpl_196, "->u.bytes = (const char*)(s + ka", 32, __cc_tpl_arena_196); cc__string_slot_push(&__cc_tpl_196, (k), __cc_tpl_arena_196); cc_string_push_buffer(&__cc_tpl_196, "); }\n    }\n", 11, __cc_tpl_arena_196); __cc_tpl_196; });
}
...
static inline CCString cc_gr_keep_codec_tape_text(CCArena* a, const char* n, int k, int rid,
    ...
    return ({ CCArena* __cc_tpl_arena_197 = (a); CCString __cc_tpl_197 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_197, "    { size_t ti", 15, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, " = c->total;\n      ", 19, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (n), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, "Node* nd", 8, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, " = &c->tape[c->total++];\n      nd", 33, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, "->meta = ", 9, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (rid), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, "u | (dr", 7, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, " ? 0x200u : 0u) | (((unsigned long long)(p - ka", 47, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, ")) << 10);\n      nd", 19, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, "->u.bytes = (const char*)(s + ka", 32, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, ");\n      if (dr", 15, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, ") {\n        if (!c->mat_ptr) {\n          c->mat_ptr = (const char**)cc_arena_alloc_local(c->arena, c->cap * sizeof(char*), 8);\n          c->mat_len = (size_t*)cc_arena_alloc_local(c->arena, c->cap * sizeof(size_t), 8);\n          c->mat_cow = (unsigned char*)cc_arena_alloc_local(c->arena, c->cap, 1);\n          if (!c->mat_ptr || !c->mat_len || !c->mat_cow) goto ", 363, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (fail), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, ";\n          memset(c->mat_ptr, 0, c->cap * sizeof(char*));\n        }\n        { CCSlice v", 88, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, ";\n          switch (", 20, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (cb), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, ") {\n          case ", 19, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (cb), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, ": if (!", 7, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (codec), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, "((const char*)(s + ka", 21, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, "), (size_t)(p - ka", 18, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, "), &v", 5, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, ", c->arena)) goto ", 18, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (fail), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, "; break;\n          default: goto ", 33, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (fail), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, ";\n          }\n          c->mat_ptr[ti", 37, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, "] = (const char*)v", 18, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, ".ptr;\n          c->mat_len[ti", 29, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, "] = v", 5, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, ".len;\n          c->mat_cow[ti", 29, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, "] = (unsigned char)cc_slice_is_unique(v", 39, __cc_tpl_arena_197); cc__string_slot_push(&__cc_tpl_197, (k), __cc_tpl_arena_197); cc_string_push_buffer(&__cc_tpl_197, ");\n        }\n      }\n    }\n    }\n", 33, __cc_tpl_arena_197); __cc_tpl_197; });
}
...
static inline CCString cc_gr_collect_begin_text(CCArena* a, const char* n, int rid,
    ...
    CCString o = cc_string_new();
    cc_gr__cat(&o, ({ CCArena* __cc_tpl_arena_198 = (a); CCString __cc_tpl_198 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_198, "    { if (c->bdepth >= 512) goto ", 33, __cc_tpl_arena_198); cc__string_slot_push(&__cc_tpl_198, (fail), __cc_tpl_arena_198); cc_string_push_buffer(&__cc_tpl_198, ";\n        if (c->total == c->cap && !", 37, __cc_tpl_arena_198); cc__string_slot_push(&__cc_tpl_198, (n), __cc_tpl_arena_198); cc_string_push_buffer(&__cc_tpl_198, "__tgrow(c)) goto ", 17, __cc_tpl_arena_198); cc__string_slot_push(&__cc_tpl_198, (fail), __cc_tpl_arena_198); cc_string_push_buffer(&__cc_tpl_198, ";\n        c->tape[c->total].meta = 0x100u | ", 44, __cc_tpl_arena_198); cc__string_slot_push(&__cc_tpl_198, (rid), __cc_tpl_arena_198); cc_string_push_buffer(&__cc_tpl_198, "u;\n        c->tape[c->total].u.bytes = (const char*)(s + p);   /* source anchor */\n", 83, __cc_tpl_arena_198); __cc_tpl_198; }), a);
    if (dom)
        cc_gr__cat(&o, ({ CCArena* __cc_tpl_arena_199 = (a); CCString __cc_tpl_199 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_199, "        if (c->sb) c->vbase[c->bdepth] = c->vsp;\n", 49, __cc_tpl_arena_199); __cc_tpl_199; }), a);
    cc_gr__cat(&o, ({ CCArena* __cc_tpl_arena_200 = (a); CCString __cc_tpl_200 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_200, "        c->bstack[c->bdepth++] = c->total++; }\n", 47, __cc_tpl_arena_200); __cc_tpl_200; }), a);
    return o;
}
...
static inline CCString cc_gr_collect_end_text(CCArena* a, const char* n,
                                              const char* fail, int dom) {
    if (dom)
        return ({ CCArena* __cc_tpl_arena_201 = (a); CCString __cc_tpl_201 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_201, "    { size_t bi = c->bstack[--c->bdepth];\n        c->tape[bi].meta |= ((unsigned long long)(c->total - bi)) << 10;\n        if (c->sb && !", 137, __cc_tpl_arena_201); cc__string_slot_push(&__cc_tpl_201, (n), __cc_tpl_arena_201); cc_string_push_buffer(&__cc_tpl_201, "__shape_end(c, bi)) goto ", 25, __cc_tpl_arena_201); cc__string_slot_push(&__cc_tpl_201, (fail), __cc_tpl_arena_201); cc_string_push_buffer(&__cc_tpl_201, ";\n    }\n", 8, __cc_tpl_arena_201); __cc_tpl_201; });
    return ({ CCArena* __cc_tpl_arena_202 = (a); CCString __cc_tpl_202 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_202, "    { size_t bi = c->bstack[--c->bdepth];\n        c->tape[bi].meta |= ((unsigned long long)(c->total - bi)) << 10; }\n", 117, __cc_tpl_arena_202); __cc_tpl_202; });
}

/* ALT first-set dispatch skeleton */
static inline CCString cc_gr_alt_disp_head_text(CCArena* a, int k) {
    return ({ CCArena* __cc_tpl_arena_203 = (a); CCString __cc_tpl_203 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_203, "    {\n    if (p >= n) goto Lb", 29, __cc_tpl_arena_203); cc__string_slot_push(&__cc_tpl_203, (k), __cc_tpl_arena_203); cc_string_push_buffer(&__cc_tpl_203, ";\n    switch (s[p]) {\n", 22, __cc_tpl_arena_203); __cc_tpl_203; });
}

static inline CCString cc_gr_alt_case_text(CCArena* a, int bch) {
    return ({ CCArena* __cc_tpl_arena_204 = (a); CCString __cc_tpl_204 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_204, "    case ", 9, __cc_tpl_arena_204); cc__string_slot_push(&__cc_tpl_204, (bch), __cc_tpl_arena_204); cc_string_push_buffer(&__cc_tpl_204, ":\n", 2, __cc_tpl_arena_204); __cc_tpl_204; });
}

static inline CCString cc_gr_mark_dirty_text(CCArena* a, int dk) {
    return ({ CCArena* __cc_tpl_arena_205 = (a); CCString __cc_tpl_205 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_205, "    dr", 6, __cc_tpl_arena_205); cc__string_slot_push(&__cc_tpl_205, (dk), __cc_tpl_arena_205); cc_string_push_buffer(&__cc_tpl_205, " = 1;\n", 6, __cc_tpl_arena_205); __cc_tpl_205; });
}

static inline CCString cc_gr_break_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_206 = (a); CCString __cc_tpl_206 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_206, "    break;\n", 11, __cc_tpl_arena_206); __cc_tpl_206; });
}

static inline CCString cc_gr_default_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_207 = (a); CCString __cc_tpl_207 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_207, "    default:\n", 13, __cc_tpl_arena_207); __cc_tpl_207; });
}

static inline CCString cc_gr_alt_default_fail_text(CCArena* a, int k) {
    return ({ CCArena* __cc_tpl_arena_208 = (a); CCString __cc_tpl_208 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_208, "    default: goto Lb", 20, __cc_tpl_arena_208); cc__string_slot_push(&__cc_tpl_208, (k), __cc_tpl_arena_208); cc_string_push_buffer(&__cc_tpl_208, ";\n", 2, __cc_tpl_arena_208); __cc_tpl_208; });
}

static inline CCString cc_gr_alt_disp_tail_text(CCArena* a, int k, const char* fail) {
    return ({ CCArena* __cc_tpl_arena_209 = (a); CCString __cc_tpl_209 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_209, "    }\n    goto Lok", 18, __cc_tpl_arena_209); cc__string_slot_push(&__cc_tpl_209, (k), __cc_tpl_arena_209); cc_string_push_buffer(&__cc_tpl_209, ";\nLb", 4, __cc_tpl_arena_209); cc__string_slot_push(&__cc_tpl_209, (k), __cc_tpl_arena_209); cc_string_push_buffer(&__cc_tpl_209, ": goto ", 7, __cc_tpl_arena_209); cc__string_slot_push(&__cc_tpl_209, (fail), __cc_tpl_arena_209); cc_string_push_buffer(&__cc_tpl_209, ";\nLok", 5, __cc_tpl_arena_209); cc__string_slot_push(&__cc_tpl_209, (k), __cc_tpl_arena_209); cc_string_push_buffer(&__cc_tpl_209, ": ; }\n", 6, __cc_tpl_arena_209); __cc_tpl_209; });
}
...
static inline CCString cc_gr_save_text(CCArena* a, int k, int risky) {
    if (risky)
        return ({ CCArena* __cc_tpl_arena_210 = (a); CCString __cc_tpl_210 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_210, "    { size_t sv", 15, __cc_tpl_arena_210); cc__string_slot_push(&__cc_tpl_210, (k), __cc_tpl_arena_210); cc_string_push_buffer(&__cc_tpl_210, " = p; size_t lt", 15, __cc_tpl_arena_210); cc__string_slot_push(&__cc_tpl_210, (k), __cc_tpl_arena_210); cc_string_push_buffer(&__cc_tpl_210, " = c->total, ld", 15, __cc_tpl_arena_210); cc__string_slot_push(&__cc_tpl_210, (k), __cc_tpl_arena_210); cc_string_push_buffer(&__cc_tpl_210, " = c->bdepth, lv", 16, __cc_tpl_arena_210); cc__string_slot_push(&__cc_tpl_210, (k), __cc_tpl_arena_210); cc_string_push_buffer(&__cc_tpl_210, " = c->vsp;\n", 11, __cc_tpl_arena_210); __cc_tpl_210; });
    return ({ CCArena* __cc_tpl_arena_211 = (a); CCString __cc_tpl_211 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_211, "    { size_t sv", 15, __cc_tpl_arena_211); cc__string_slot_push(&__cc_tpl_211, (k), __cc_tpl_arena_211); cc_string_push_buffer(&__cc_tpl_211, " = p;\n", 6, __cc_tpl_arena_211); __cc_tpl_211; });
}

static inline CCString cc_gr_goto_ok_text(CCArena* a, int k) {
    return ({ CCArena* __cc_tpl_arena_212 = (a); CCString __cc_tpl_212 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_212, "    goto Lok", 12, __cc_tpl_arena_212); cc__string_slot_push(&__cc_tpl_212, (k), __cc_tpl_arena_212); cc_string_push_buffer(&__cc_tpl_212, ";\n", 2, __cc_tpl_arena_212); __cc_tpl_212; });
}
...
static inline CCString cc_gr_restore_text(CCArena* a, const char* br, int k, int rk,
                                          const char* n) {
    if (rk == 2)
        return ({ CCArena* __cc_tpl_arena_213 = (a); CCString __cc_tpl_213 = cc_string_new(); cc__string_slot_push(&__cc_tpl_213, (br), __cc_tpl_arena_213); cc_string_push_buffer(&__cc_tpl_213, ": p = sv", 8, __cc_tpl_arena_213); cc__string_slot_push(&__cc_tpl_213, (k), __cc_tpl_arena_213); cc_string_push_buffer(&__cc_tpl_213, "; { c->total = lt", 17, __cc_tpl_arena_213); cc__string_slot_push(&__cc_tpl_213, (k), __cc_tpl_arena_213); cc_string_push_buffer(&__cc_tpl_213, "; c->bdepth = ld", 16, __cc_tpl_arena_213); cc__string_slot_push(&__cc_tpl_213, (k), __cc_tpl_arena_213); cc_string_push_buffer(&__cc_tpl_213, "; c->vsp = lv", 13, __cc_tpl_arena_213); cc__string_slot_push(&__cc_tpl_213, (k), __cc_tpl_arena_213); cc_string_push_buffer(&__cc_tpl_213, "; }\n", 4, __cc_tpl_arena_213); __cc_tpl_213; });
    if (rk == 1)
        return ({ CCArena* __cc_tpl_arena_214 = (a); CCString __cc_tpl_214 = cc_string_new(); cc__string_slot_push(&__cc_tpl_214, (br), __cc_tpl_arena_214); cc_string_push_buffer(&__cc_tpl_214, ": p = sv", 8, __cc_tpl_arena_214); cc__string_slot_push(&__cc_tpl_214, (k), __cc_tpl_arena_214); cc_string_push_buffer(&__cc_tpl_214, "; ", 2, __cc_tpl_arena_214); cc__string_slot_push(&__cc_tpl_214, (n), __cc_tpl_arena_214); cc_string_push_buffer(&__cc_tpl_214, "__unwind(c, s + p);\n", 20, __cc_tpl_arena_214); __cc_tpl_214; });
    return ({ CCArena* __cc_tpl_arena_215 = (a); CCString __cc_tpl_215 = cc_string_new(); cc__string_slot_push(&__cc_tpl_215, (br), __cc_tpl_arena_215); cc_string_push_buffer(&__cc_tpl_215, ": p = sv", 8, __cc_tpl_arena_215); cc__string_slot_push(&__cc_tpl_215, (k), __cc_tpl_arena_215); cc_string_push_buffer(&__cc_tpl_215, ";\n", 2, __cc_tpl_arena_215); __cc_tpl_215; });
}

static inline CCString cc_gr_goto_fail_text(CCArena* a, const char* fail) {
    return ({ CCArena* __cc_tpl_arena_216 = (a); CCString __cc_tpl_216 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_216, "    goto ", 9, __cc_tpl_arena_216); cc__string_slot_push(&__cc_tpl_216, (fail), __cc_tpl_arena_216); cc_string_push_buffer(&__cc_tpl_216, ";\n", 2, __cc_tpl_arena_216); __cc_tpl_216; });
}

static inline CCString cc_gr_ok_close_text(CCArena* a, int k) {
    return ({ CCArena* __cc_tpl_arena_217 = (a); CCString __cc_tpl_217 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_217, "Lok", 3, __cc_tpl_arena_217); cc__string_slot_push(&__cc_tpl_217, (k), __cc_tpl_arena_217); cc_string_push_buffer(&__cc_tpl_217, ": ; }\n", 6, __cc_tpl_arena_217); __cc_tpl_217; });
}

/* fused string-body scan: SWAR run + escape arm */
static inline CCString cc_gr_forever_open_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_218 = (a); CCString __cc_tpl_218 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_218, "    for (;;) {\n", 15, __cc_tpl_arena_218); __cc_tpl_218; });
}

static inline CCString cc_gr_cs_run_text(CCArena* a, CCString cx) {
    return ({ CCArena* __cc_tpl_arena_219 = (a); CCString __cc_tpl_219 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_219, "    while (p < n && ", 20, __cc_tpl_arena_219); cc__string_slot_push(&__cc_tpl_219, (cx), __cc_tpl_arena_219); cc_string_push_buffer(&__cc_tpl_219, ") p++;\n", 7, __cc_tpl_arena_219); __cc_tpl_219; });
}

static inline CCString cc_gr_scan_esc_tail_text(CCArena* a, const char* br, int k) {
    return ({ CCArena* __cc_tpl_arena_220 = (a); CCString __cc_tpl_220 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_220, "    continue;\n", 14, __cc_tpl_arena_220); cc__string_slot_push(&__cc_tpl_220, (br), __cc_tpl_arena_220); cc_string_push_buffer(&__cc_tpl_220, ": p = sv", 8, __cc_tpl_arena_220); cc__string_slot_push(&__cc_tpl_220, (k), __cc_tpl_arena_220); cc_string_push_buffer(&__cc_tpl_220, "; }\n    break;\n    }\n", 21, __cc_tpl_arena_220); __cc_tpl_220; });
}

/* any/some generic loop frame */
static inline CCString cc_gr_loop_head_text(CCArena* a, int k, int risky) {
    if (risky)
        return ({ CCArena* __cc_tpl_arena_221 = (a); CCString __cc_tpl_221 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_221, "    { size_t sv", 15, __cc_tpl_arena_221); cc__string_slot_push(&__cc_tpl_221, (k), __cc_tpl_arena_221); cc_string_push_buffer(&__cc_tpl_221, "; size_t lt", 11, __cc_tpl_arena_221); cc__string_slot_push(&__cc_tpl_221, (k), __cc_tpl_arena_221); cc_string_push_buffer(&__cc_tpl_221, " = 0, ld", 8, __cc_tpl_arena_221); cc__string_slot_push(&__cc_tpl_221, (k), __cc_tpl_arena_221); cc_string_push_buffer(&__cc_tpl_221, " = 0, lv", 8, __cc_tpl_arena_221); cc__string_slot_push(&__cc_tpl_221, (k), __cc_tpl_arena_221); cc_string_push_buffer(&__cc_tpl_221, " = 0;\n    for (;;) { sv", 23, __cc_tpl_arena_221); cc__string_slot_push(&__cc_tpl_221, (k), __cc_tpl_arena_221); cc_string_push_buffer(&__cc_tpl_221, " = p; lt", 8, __cc_tpl_arena_221); cc__string_slot_push(&__cc_tpl_221, (k), __cc_tpl_arena_221); cc_string_push_buffer(&__cc_tpl_221, " = c->total; ld", 15, __cc_tpl_arena_221); cc__string_slot_push(&__cc_tpl_221, (k), __cc_tpl_arena_221); cc_string_push_buffer(&__cc_tpl_221, " = c->bdepth; lv", 16, __cc_tpl_arena_221); cc__string_slot_push(&__cc_tpl_221, (k), __cc_tpl_arena_221); cc_string_push_buffer(&__cc_tpl_221, " = c->vsp;\n", 11, __cc_tpl_arena_221); __cc_tpl_221; });
    return ({ CCArena* __cc_tpl_arena_222 = (a); CCString __cc_tpl_222 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_222, "    { size_t sv", 15, __cc_tpl_arena_222); cc__string_slot_push(&__cc_tpl_222, (k), __cc_tpl_arena_222); cc_string_push_buffer(&__cc_tpl_222, ";\n    for (;;) { sv", 19, __cc_tpl_arena_222); cc__string_slot_push(&__cc_tpl_222, (k), __cc_tpl_arena_222); cc_string_push_buffer(&__cc_tpl_222, " = p;\n", 6, __cc_tpl_arena_222); __cc_tpl_222; });
}

static inline CCString cc_gr_loop_break_text(CCArena* a, int k) {
    return ({ CCArena* __cc_tpl_arena_223 = (a); CCString __cc_tpl_223 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_223, "    if (p == sv", 15, __cc_tpl_arena_223); cc__string_slot_push(&__cc_tpl_223, (k), __cc_tpl_arena_223); cc_string_push_buffer(&__cc_tpl_223, ") break;\n    }\n", 15, __cc_tpl_arena_223); __cc_tpl_223; });
}
...
static inline CCString cc_gr_rules_manifest_head_text(CCArena* a, const char* n,
                                                      int line, int nrules) {
    return ({ CCArena* __cc_tpl_arena_224 = (a); CCString __cc_tpl_224 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_224, "/* @grammar(rules) ", 19, __cc_tpl_arena_224); cc__string_slot_push(&__cc_tpl_224, (n), __cc_tpl_arena_224); cc_string_push_buffer(&__cc_tpl_224, " (line ", 7, __cc_tpl_arena_224); cc__string_slot_push(&__cc_tpl_224, (line), __cc_tpl_arena_224); cc_string_push_buffer(&__cc_tpl_224, "): ", 3, __cc_tpl_arena_224); cc__string_slot_push(&__cc_tpl_224, (nrules), __cc_tpl_arena_224); cc_string_push_buffer(&__cc_tpl_224, " rule(s). API:\n", 15, __cc_tpl_arena_224); __cc_tpl_224; });
}

static inline CCString cc_gr_rules_manifest_match_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_225 = (a); CCString __cc_tpl_225 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_225, " *   cc_match(", 14, __cc_tpl_arena_225); cc__string_slot_push(&__cc_tpl_225, (n), __cc_tpl_arena_225); cc_string_push_buffer(&__cc_tpl_225, ", s, n)                     -> ", 31, __cc_tpl_arena_225); cc__string_slot_push(&__cc_tpl_225, (n), __cc_tpl_arena_225); cc_string_push_buffer(&__cc_tpl_225, "_match\n", 7, __cc_tpl_arena_225); __cc_tpl_225; });
}

static inline CCString cc_gr_rules_manifest_parse_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_226 = (a); CCString __cc_tpl_226 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_226, " *   cc_parse(", 14, __cc_tpl_arena_226); cc__string_slot_push(&__cc_tpl_226, (n), __cc_tpl_arena_226); cc_string_push_buffer(&__cc_tpl_226, ", s, n, arena)              -> ", 31, __cc_tpl_arena_226); cc__string_slot_push(&__cc_tpl_226, (n), __cc_tpl_arena_226); cc_string_push_buffer(&__cc_tpl_226, "_parse -> ", 10, __cc_tpl_arena_226); cc__string_slot_push(&__cc_tpl_226, (n), __cc_tpl_arena_226); cc_string_push_buffer(&__cc_tpl_226, "Node* tape\n", 11, __cc_tpl_arena_226); __cc_tpl_226; });
}

static inline CCString cc_gr_rules_manifest_collect_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_227 = (a); CCString __cc_tpl_227 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_227, " *   cc_collect(", 16, __cc_tpl_arena_227); cc__string_slot_push(&__cc_tpl_227, (n), __cc_tpl_arena_227); cc_string_push_buffer(&__cc_tpl_227, ", s, n, arena, cb, env)   -> ", 29, __cc_tpl_arena_227); cc__string_slot_push(&__cc_tpl_227, (n), __cc_tpl_arena_227); cc_string_push_buffer(&__cc_tpl_227, "_collect\n", 9, __cc_tpl_arena_227); __cc_tpl_227; });
}

static inline CCString cc_gr_rules_manifest_dom_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_228 = (a); CCString __cc_tpl_228 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_228, " *   cc_dom(", 12, __cc_tpl_arena_228); cc__string_slot_push(&__cc_tpl_228, (n), __cc_tpl_arena_228); cc_string_push_buffer(&__cc_tpl_228, ", s, n, reg, arena, &out)      -> ", 34, __cc_tpl_arena_228); cc__string_slot_push(&__cc_tpl_228, (n), __cc_tpl_arena_228); cc_string_push_buffer(&__cc_tpl_228, "_dom (shaped: hidden-class DOM)\n", 32, __cc_tpl_arena_228); __cc_tpl_228; });
}

static inline CCString cc_gr_rules_manifest_nodes_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_229 = (a); CCString __cc_tpl_229 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_229, " *   nodes: ", 12, __cc_tpl_arena_229); cc__string_slot_push(&__cc_tpl_229, (n), __cc_tpl_arena_229); cc_string_push_buffer(&__cc_tpl_229, "Node_{id,is_list,len,first,next,count,slice}; ids: ", 51, __cc_tpl_arena_229); cc__string_slot_push(&__cc_tpl_229, (n), __cc_tpl_arena_229); cc_string_push_buffer(&__cc_tpl_229, "_KEEP_<rule>\n", 13, __cc_tpl_arena_229); __cc_tpl_229; });
}

static inline CCString cc_gr_rules_manifest_none_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_230 = (a); CCString __cc_tpl_230 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_230, " *   (no tier referenced by this file -> none emitted; factory only)\n", 69, __cc_tpl_arena_230); __cc_tpl_230; });
}

static inline CCString cc_gr_rules_manifest_close_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_231 = (a); CCString __cc_tpl_231 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_231, " */\n", 4, __cc_tpl_arena_231); __cc_tpl_231; });
}

static inline CCString cc_gr_rules_typedef_text(CCArena* a, const char* n, int nrules) {
    return ({ CCArena* __cc_tpl_arena_232 = (a); CCString __cc_tpl_232 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_232, "typedef struct { int rule_count; } ", 35, __cc_tpl_arena_232); cc__string_slot_push(&__cc_tpl_232, (n), __cc_tpl_arena_232); cc_string_push_buffer(&__cc_tpl_232, ";\nstatic inline int ", 20, __cc_tpl_arena_232); cc__string_slot_push(&__cc_tpl_232, (n), __cc_tpl_arena_232); cc_string_push_buffer(&__cc_tpl_232, "_rule_count(void) { return ", 27, __cc_tpl_arena_232); cc__string_slot_push(&__cc_tpl_232, (nrules), __cc_tpl_arena_232); cc_string_push_buffer(&__cc_tpl_232, "; }\n", 4, __cc_tpl_arena_232); __cc_tpl_232; });
}

/* codec table: rule id -> codec index (0 = none) */
static inline CCString cc_gr_codec_of_head_text(CCArena* a, const char* n, int nrules) {
    return ({ CCArena* __cc_tpl_arena_233 = (a); CCString __cc_tpl_233 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_233, "static const short ", 19, __cc_tpl_arena_233); cc__string_slot_push(&__cc_tpl_233, (n), __cc_tpl_arena_233); cc_string_push_buffer(&__cc_tpl_233, "__codec_of[", 11, __cc_tpl_arena_233); cc__string_slot_push(&__cc_tpl_233, (nrules), __cc_tpl_arena_233); cc_string_push_buffer(&__cc_tpl_233, "] = {", 5, __cc_tpl_arena_233); __cc_tpl_233; });
}

static inline CCString cc_gr_short_item_text(CCArena* a, int v) {
    return ({ CCArena* __cc_tpl_arena_234 = (a); CCString __cc_tpl_234 = cc_string_new(); cc__string_slot_push(&__cc_tpl_234, (v), __cc_tpl_arena_234); cc_string_push_buffer(&__cc_tpl_234, ",", 1, __cc_tpl_arena_234); __cc_tpl_234; });
}
...
static inline CCString cc_gr_unwind_fn_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_235 = (a); CCString __cc_tpl_235 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_235, "static __attribute__((noinline)) void ", 38, __cc_tpl_arena_235); cc__string_slot_push(&__cc_tpl_235, (n), __cc_tpl_arena_235); cc_string_push_buffer(&__cc_tpl_235, "__unwind(", 9, __cc_tpl_arena_235); cc__string_slot_push(&__cc_tpl_235, (n), __cc_tpl_arena_235); cc_string_push_buffer(&__cc_tpl_235, "__ctx* c, const unsigned char* sv) {\n    while (c->total > 1 && (const unsigned char*)c->tape[c->total - 1].u.bytes >= sv)\n        c->total--;\n    while (c->bdepth > 0 && c->bstack[c->bdepth - 1] >= c->total) c->bdepth--;\n    if (c->vanchor)\n        while (c->vsp > 0 && c->vanchor[c->vsp - 1] >= sv) c->vsp--;\n}\n", 313, __cc_tpl_arena_235); __cc_tpl_235; });
}

static inline CCString cc_gr_shape_end_proto_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_236 = (a); CCString __cc_tpl_236 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_236, "static int ", 11, __cc_tpl_arena_236); cc__string_slot_push(&__cc_tpl_236, (n), __cc_tpl_arena_236); cc_string_push_buffer(&__cc_tpl_236, "__shape_end(", 12, __cc_tpl_arena_236); cc__string_slot_push(&__cc_tpl_236, (n), __cc_tpl_arena_236); cc_string_push_buffer(&__cc_tpl_236, "__ctx* c, size_t bi);\n", 22, __cc_tpl_arena_236); __cc_tpl_236; });
}

static inline CCString cc_gr_keep_def_text(CCArena* a, const char* n, const char* r, int rid) {
    return ({ CCArena* __cc_tpl_arena_237 = (a); CCString __cc_tpl_237 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_237, "#define ", 8, __cc_tpl_arena_237); cc__string_slot_push(&__cc_tpl_237, (n), __cc_tpl_arena_237); cc_string_push_buffer(&__cc_tpl_237, "_KEEP_", 6, __cc_tpl_arena_237); cc__string_slot_push(&__cc_tpl_237, (r), __cc_tpl_arena_237); cc_string_push_buffer(&__cc_tpl_237, " ", 1, __cc_tpl_arena_237); cc__string_slot_push(&__cc_tpl_237, (rid), __cc_tpl_arena_237); cc_string_push_buffer(&__cc_tpl_237, "\n", 1, __cc_tpl_arena_237); __cc_tpl_237; });
}
...
static inline CCString cc_gr_rule_proto_text(CCArena* a, const char* al, const char* n,
                                             ...
                                             int with_ctx) {
    if (with_ctx)
        return ({ CCArena* __cc_tpl_arena_238 = (a); CCString __cc_tpl_238 = cc_string_new(); cc__string_slot_push(&__cc_tpl_238, (al), __cc_tpl_arena_238); cc__string_slot_push(&__cc_tpl_238, (n), __cc_tpl_arena_238); cc_string_push_buffer(&__cc_tpl_238, "__", 2, __cc_tpl_arena_238); cc__string_slot_push(&__cc_tpl_238, (cls), __cc_tpl_arena_238); cc_string_push_buffer(&__cc_tpl_238, "_", 1, __cc_tpl_arena_238); cc__string_slot_push(&__cc_tpl_238, (r), __cc_tpl_arena_238); cc__string_slot_push(&__cc_tpl_238, (suf), __cc_tpl_arena_238); cc_string_push_buffer(&__cc_tpl_238, "(", 1, __cc_tpl_arena_238); cc__string_slot_push(&__cc_tpl_238, (n), __cc_tpl_arena_238); cc_string_push_buffer(&__cc_tpl_238, "__ctx* c, const unsigned char* s, size_t n, size_t* io);\n", 57, __cc_tpl_arena_238); __cc_tpl_238; });
    return ({ CCArena* __cc_tpl_arena_239 = (a); CCString __cc_tpl_239 = cc_string_new(); cc__string_slot_push(&__cc_tpl_239, (al), __cc_tpl_arena_239); cc__string_slot_push(&__cc_tpl_239, (n), __cc_tpl_arena_239); cc_string_push_buffer(&__cc_tpl_239, "__", 2, __cc_tpl_arena_239); cc__string_slot_push(&__cc_tpl_239, (cls), __cc_tpl_arena_239); cc_string_push_buffer(&__cc_tpl_239, "_", 1, __cc_tpl_arena_239); cc__string_slot_push(&__cc_tpl_239, (r), __cc_tpl_arena_239); cc__string_slot_push(&__cc_tpl_239, (suf), __cc_tpl_arena_239); cc_string_push_buffer(&__cc_tpl_239, "(const unsigned char* s, size_t n, size_t* io);\n", 48, __cc_tpl_arena_239); __cc_tpl_239; });
}
...
static inline CCString cc_gr_rule_head_text(CCArena* a, const char* al, const char* n,
                                            ...
                                            int with_ctx) {
    if (with_ctx)
        return ({ CCArena* __cc_tpl_arena_240 = (a); CCString __cc_tpl_240 = cc_string_new(); cc__string_slot_push(&__cc_tpl_240, (al), __cc_tpl_arena_240); cc__string_slot_push(&__cc_tpl_240, (n), __cc_tpl_arena_240); cc_string_push_buffer(&__cc_tpl_240, "__", 2, __cc_tpl_arena_240); cc__string_slot_push(&__cc_tpl_240, (cls), __cc_tpl_arena_240); cc_string_push_buffer(&__cc_tpl_240, "_", 1, __cc_tpl_arena_240); cc__string_slot_push(&__cc_tpl_240, (r), __cc_tpl_arena_240); cc__string_slot_push(&__cc_tpl_240, (suf), __cc_tpl_arena_240); cc_string_push_buffer(&__cc_tpl_240, "(", 1, __cc_tpl_arena_240); cc__string_slot_push(&__cc_tpl_240, (n), __cc_tpl_arena_240); cc_string_push_buffer(&__cc_tpl_240, "__ctx* c, const unsigned char* s, size_t n, size_t* io) {\n    size_t p = *io;\n    (void)c; (void)s; (void)n;\n", 109, __cc_tpl_arena_240); __cc_tpl_240; });
    return ({ CCArena* __cc_tpl_arena_241 = (a); CCString __cc_tpl_241 = cc_string_new(); cc__string_slot_push(&__cc_tpl_241, (al), __cc_tpl_arena_241); cc__string_slot_push(&__cc_tpl_241, (n), __cc_tpl_arena_241); cc_string_push_buffer(&__cc_tpl_241, "__", 2, __cc_tpl_arena_241); cc__string_slot_push(&__cc_tpl_241, (cls), __cc_tpl_arena_241); cc_string_push_buffer(&__cc_tpl_241, "_", 1, __cc_tpl_arena_241); cc__string_slot_push(&__cc_tpl_241, (r), __cc_tpl_arena_241); cc__string_slot_push(&__cc_tpl_241, (suf), __cc_tpl_arena_241); cc_string_push_buffer(&__cc_tpl_241, "(const unsigned char* s, size_t n, size_t* io) {\n    size_t p = *io;\n    (void)s; (void)n;\n", 91, __cc_tpl_arena_241); __cc_tpl_241; });
}

/* padded-entry trampoline scaffold around the lead pad + __np call */
static inline CCString cc_gr_pp_open_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_242 = (a); CCString __cc_tpl_242 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_242, "    { size_t _pp = p;\n", 22, __cc_tpl_arena_242); __cc_tpl_242; });
}

static inline CCString cc_gr_pp_close_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_243 = (a); CCString __cc_tpl_243 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_243, "    (void)_pp; }\n", 17, __cc_tpl_arena_243); __cc_tpl_243; });
}

static inline CCString cc_gr_entry_def_text(CCArena* a, const char* n, const char* which,
                                            const char* cls, const char* r0) {
    return ({ CCArena* __cc_tpl_arena_244 = (a); CCString __cc_tpl_244 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_244, "#define ", 8, __cc_tpl_arena_244); cc__string_slot_push(&__cc_tpl_244, (n), __cc_tpl_arena_244); cc_string_push_buffer(&__cc_tpl_244, "__ENTRY_", 8, __cc_tpl_arena_244); cc__string_slot_push(&__cc_tpl_244, (which), __cc_tpl_arena_244); cc_string_push_buffer(&__cc_tpl_244, " ", 1, __cc_tpl_arena_244); cc__string_slot_push(&__cc_tpl_244, (n), __cc_tpl_arena_244); cc_string_push_buffer(&__cc_tpl_244, "__", 2, __cc_tpl_arena_244); cc__string_slot_push(&__cc_tpl_244, (cls), __cc_tpl_arena_244); cc_string_push_buffer(&__cc_tpl_244, "_", 1, __cc_tpl_arena_244); cc__string_slot_push(&__cc_tpl_244, (r0), __cc_tpl_arena_244); cc_string_push_buffer(&__cc_tpl_244, "\n", 1, __cc_tpl_arena_244); __cc_tpl_244; });
}

static inline CCString cc_gr_entry_pure_def_text(CCArena* a, const char* n, int pure0) {
    return ({ CCArena* __cc_tpl_arena_245 = (a); CCString __cc_tpl_245 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_245, "#define ", 8, __cc_tpl_arena_245); cc__string_slot_push(&__cc_tpl_245, (n), __cc_tpl_arena_245); cc_string_push_buffer(&__cc_tpl_245, "__ENTRY_PURE ", 13, __cc_tpl_arena_245); cc__string_slot_push(&__cc_tpl_245, (pure0), __cc_tpl_arena_245); cc_string_push_buffer(&__cc_tpl_245, "\n", 1, __cc_tpl_arena_245); __cc_tpl_245; });
}
...
static inline CCString cc_gr_parse_entry_head_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_246 = (a); CCString __cc_tpl_246 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_246, "static ", 7, __cc_tpl_arena_246); cc__string_slot_push(&__cc_tpl_246, (n), __cc_tpl_arena_246); cc_string_push_buffer(&__cc_tpl_246, "Node* ", 6, __cc_tpl_arena_246); cc__string_slot_push(&__cc_tpl_246, (n), __cc_tpl_arena_246); cc_string_push_buffer(&__cc_tpl_246, "_parse(const char* s, size_t n, CCArena* arena) {\n    ", 54, __cc_tpl_arena_246); cc__string_slot_push(&__cc_tpl_246, (n), __cc_tpl_arena_246); cc_string_push_buffer(&__cc_tpl_246, "__ctx c0;\n    size_t p = 0;\n    c0.cap = 2048 + (n / 24);  /* ~real density; tgrow covers denser input */\n    c0.tape = (", 121, __cc_tpl_arena_246); cc__string_slot_push(&__cc_tpl_246, (n), __cc_tpl_arena_246); cc_string_push_buffer(&__cc_tpl_246, "Node*)cc_arena_alloc_local(arena, c0.cap * sizeof(", 50, __cc_tpl_arena_246); cc__string_slot_push(&__cc_tpl_246, (n), __cc_tpl_arena_246); cc_string_push_buffer(&__cc_tpl_246, "Node), _Alignof(", 16, __cc_tpl_arena_246); cc__string_slot_push(&__cc_tpl_246, (n), __cc_tpl_arena_246); cc_string_push_buffer(&__cc_tpl_246, "Node));\n    if (!c0.tape) return 0;\n    c0.total = 1; c0.bdepth = 0; c0.arena = arena;\n    c0.mat_ptr = 0; c0.mat_len = 0; c0.mat_cow = 0;\n    c0.sb = 0; c0.vstack = 0; c0.vanchor = 0; c0.vsp = 0; c0.vcap = 0;\n    c0.tape[0].meta = 0x100u | 0xFFu;   /* root list */\n    c0.tape[0].u.bytes = s;             /* source anchor */\n#if ", 330, __cc_tpl_arena_246); cc__string_slot_push(&__cc_tpl_246, (n), __cc_tpl_arena_246); cc_string_push_buffer(&__cc_tpl_246, "__ENTRY_PURE\n    if (!", 22, __cc_tpl_arena_246); cc__string_slot_push(&__cc_tpl_246, (n), __cc_tpl_arena_246); cc_string_push_buffer(&__cc_tpl_246, "__ENTRY_B((const unsigned char*)s, n, &p) || p != n) return 0;\n#else\n    if (!", 78, __cc_tpl_arena_246); cc__string_slot_push(&__cc_tpl_246, (n), __cc_tpl_arena_246); cc_string_push_buffer(&__cc_tpl_246, "__ENTRY_B(&c0, (const unsigned char*)s, n, &p) || p != n) return 0;\n#endif\n    c0.tape[0].meta |= ((unsigned long long)c0.total) << 10;\n", 136, __cc_tpl_arena_246); __cc_tpl_246; });
}
...
static inline CCString cc_gr_mat_head_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_247 = (a); CCString __cc_tpl_247 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_247, "    { size_t t;\n    for (t = 1; t < c0.total; t++) {\n        unsigned long long m = c0.tape[t].meta;\n        if ((m & 0x300u) != 0x200u) continue;   /* dirty leaves only */\n        { int id = (int)(m & 0xFFu);\n          if (c0.mat_ptr && c0.mat_ptr[t]) {\n            c0.tape[t].meta = (unsigned long long)id\n                | (c0.mat_cow[t] ? 0x200u : 0u)\n                | (((unsigned long long)c0.mat_len[t]) << 10);\n            c0.tape[t].u.bytes = c0.mat_ptr[t];\n            continue;\n          }\n          { CCSlice v;\n            const char* kp = c0.tape[t].u.bytes;\n            size_t kl = (size_t)(m >> 10);\n            switch (", 636, __cc_tpl_arena_247); cc__string_slot_push(&__cc_tpl_247, (n), __cc_tpl_arena_247); cc_string_push_buffer(&__cc_tpl_247, "__codec_of[id]) {\n", 18, __cc_tpl_arena_247); __cc_tpl_247; });
}

static inline CCString cc_gr_mat_case_text(CCArena* a, int ci, const char* codec) {
    return ({ CCArena* __cc_tpl_arena_248 = (a); CCString __cc_tpl_248 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_248, "            case ", 17, __cc_tpl_arena_248); cc__string_slot_push(&__cc_tpl_248, (ci), __cc_tpl_arena_248); cc_string_push_buffer(&__cc_tpl_248, ": if (!", 7, __cc_tpl_arena_248); cc__string_slot_push(&__cc_tpl_248, (codec), __cc_tpl_arena_248); cc_string_push_buffer(&__cc_tpl_248, "(kp, kl, &v, arena)) return 0; break;\n", 38, __cc_tpl_arena_248); __cc_tpl_248; });
}

static inline CCString cc_gr_mat_tail_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_249 = (a); CCString __cc_tpl_249 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_249, "            default: continue;\n            }\n            c0.tape[t].meta = (unsigned long long)id\n                | (cc_slice_is_unique(v) ? 0x200u : 0u)\n                | (((unsigned long long)v.len) << 10);\n            c0.tape[t].u.bytes = (const char*)v.ptr; } }\n    } }\n", 274, __cc_tpl_arena_249); __cc_tpl_249; });
}

static inline CCString cc_gr_parse_entry_tail_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_250 = (a); CCString __cc_tpl_250 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_250, "    return c0.tape;\n}\n", 22, __cc_tpl_arena_250); __cc_tpl_250; });
}

static inline CCString cc_gr_collect_fn_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_251 = (a); CCString __cc_tpl_251 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_251, "static int ", 11, __cc_tpl_arena_251); cc__string_slot_push(&__cc_tpl_251, (n), __cc_tpl_arena_251); cc_string_push_buffer(&__cc_tpl_251, "_collect(const char* s, size_t n, CCArena* arena,\n        int (*cb)(void* env, int id, CCSlice v), void* env) {\n    ", 116, __cc_tpl_arena_251); cc__string_slot_push(&__cc_tpl_251, (n), __cc_tpl_arena_251); cc_string_push_buffer(&__cc_tpl_251, "Node* tape = ", 13, __cc_tpl_arena_251); cc__string_slot_push(&__cc_tpl_251, (n), __cc_tpl_arena_251); cc_string_push_buffer(&__cc_tpl_251, "_parse(s, n, arena);\n    if (!tape) return 0;\n    { size_t total = (size_t)(tape[0].meta >> 10);\n    for (size_t t = 1; t < total; t++) {\n        if ((tape[t].meta >> 8) & 1u) continue;   /* interior */\n        { CCSlice v; ", 224, __cc_tpl_arena_251); cc__string_slot_push(&__cc_tpl_251, (n), __cc_tpl_arena_251); cc_string_push_buffer(&__cc_tpl_251, "Node_slice(&tape[t], &v);\n          if (cb(env, (int)(tape[t].meta & 0xFFu), v)) return 0; }\n    } }\n    return 1;\n}\n", 117, __cc_tpl_arena_251); __cc_tpl_251; });
}
...
static inline CCString cc_gr_dynobj_head_text(CCArena* a, const char* n, int nrules) {
    return ({ CCArena* __cc_tpl_arena_252 = (a); CCString __cc_tpl_252 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_252, "static const unsigned char ", 27, __cc_tpl_arena_252); cc__string_slot_push(&__cc_tpl_252, (n), __cc_tpl_arena_252); cc_string_push_buffer(&__cc_tpl_252, "__dynobj[", 9, __cc_tpl_arena_252); cc__string_slot_push(&__cc_tpl_252, (nrules), __cc_tpl_arena_252); cc_string_push_buffer(&__cc_tpl_252, "] = {", 5, __cc_tpl_arena_252); __cc_tpl_252; });
}

static inline CCString cc_gr_dynobj_item_text(CCArena* a, const char* sep, int v) {
    return ({ CCArena* __cc_tpl_arena_253 = (a); CCString __cc_tpl_253 = cc_string_new(); cc__string_slot_push(&__cc_tpl_253, (sep), __cc_tpl_arena_253); cc__string_slot_push(&__cc_tpl_253, (v), __cc_tpl_arena_253); __cc_tpl_253; });
}

static inline CCString cc_gr_vgrow_fn_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_254 = (a); CCString __cc_tpl_254 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_254, "static __attribute__((noinline)) int ", 37, __cc_tpl_arena_254); cc__string_slot_push(&__cc_tpl_254, (n), __cc_tpl_arena_254); cc_string_push_buffer(&__cc_tpl_254, "__vgrow(", 8, __cc_tpl_arena_254); cc__string_slot_push(&__cc_tpl_254, (n), __cc_tpl_arena_254); cc_string_push_buffer(&__cc_tpl_254, "__ctx* c) {\n    size_t nc = c->vcap * 2;\n    CCShapeVal* nv = (CCShapeVal*)cc_arena_realloc(c->arena, c->arena, c->vstack,\n        c->vcap * sizeof(CCShapeVal), nc * sizeof(CCShapeVal), 16);\n    const unsigned char** na = (const unsigned char**)cc_arena_realloc(c->arena, c->arena,\n        (void*)c->vanchor, c->vcap * sizeof(void*), nc * sizeof(void*), 16);\n    if (!nv || !na) return 0;\n    c->vstack = nv; c->vanchor = na; c->vcap = nc; return 1;\n}\n", 452, __cc_tpl_arena_254); __cc_tpl_254; });
}

static inline CCString cc_gr_shape_leaf_head_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_255 = (a); CCString __cc_tpl_255 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_255, "static int ", 11, __cc_tpl_arena_255); cc__string_slot_push(&__cc_tpl_255, (n), __cc_tpl_arena_255); cc_string_push_buffer(&__cc_tpl_255, "__shape_leaf(", 13, __cc_tpl_arena_255); cc__string_slot_push(&__cc_tpl_255, (n), __cc_tpl_arena_255); cc_string_push_buffer(&__cc_tpl_255, "__ctx* c, const ", 16, __cc_tpl_arena_255); cc__string_slot_push(&__cc_tpl_255, (n), __cc_tpl_arena_255); cc_string_push_buffer(&__cc_tpl_255, "Node* ln, CCShapeVal* out) {\n    unsigned long long m = ln->meta;\n    int id = (int)(m & 0xFFu);\n", 97, __cc_tpl_arena_255); __cc_tpl_255; });
}

static inline CCString cc_gr_shape_leaf_dirty_head_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_256 = (a); CCString __cc_tpl_256 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_256, "    if (m & 0x200u) {   /* dirty: prefer keep-commit stash; else decode */\n        size_t ti = (size_t)(ln - c->tape);\n        if (c->mat_ptr && c->mat_ptr[ti]) {\n            *out = cc_shape_leaf(id, c->mat_ptr[ti], c->mat_len[ti], c->mat_cow[ti]);\n            return 1;\n        }\n        { CCSlice v;\n        switch (", 318, __cc_tpl_arena_256); cc__string_slot_push(&__cc_tpl_256, (n), __cc_tpl_arena_256); cc_string_push_buffer(&__cc_tpl_256, "__codec_of[id]) {\n", 18, __cc_tpl_arena_256); __cc_tpl_256; });
}

static inline CCString cc_gr_shape_leaf_case_text(CCArena* a, int ci, const char* codec) {
    return ({ CCArena* __cc_tpl_arena_257 = (a); CCString __cc_tpl_257 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_257, "        case ", 13, __cc_tpl_arena_257); cc__string_slot_push(&__cc_tpl_257, (ci), __cc_tpl_arena_257); cc_string_push_buffer(&__cc_tpl_257, ": if (!", 7, __cc_tpl_arena_257); cc__string_slot_push(&__cc_tpl_257, (codec), __cc_tpl_arena_257); cc_string_push_buffer(&__cc_tpl_257, "((const char*)ln->u.bytes, (size_t)(m >> 10), &v, c->arena)) return 0; break;\n", 78, __cc_tpl_arena_257); __cc_tpl_257; });
}

static inline CCString cc_gr_shape_leaf_dirty_tail_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_258 = (a); CCString __cc_tpl_258 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_258, "        default: *out = cc_shape_leaf(id, ln->u.bytes, (size_t)(m >> 10), 0); return 1;\n        }\n        *out = cc_shape_leaf(id, (const char*)v.ptr, v.len, cc_slice_is_unique(v));\n        return 1; }\n    }\n", 208, __cc_tpl_arena_258); __cc_tpl_258; });
}

static inline CCString cc_gr_shape_leaf_tail_text(CCArena* a) {
    return ({ CCArena* __cc_tpl_arena_259 = (a); CCString __cc_tpl_259 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_259, "    *out = cc_shape_leaf(id, ln->u.bytes, (size_t)(m >> 10), 0);\n    return 1;\n}\n", 81, __cc_tpl_arena_259); __cc_tpl_259; });
}

static inline CCString cc_gr_shape_end_fn_text(CCArena* a, const char* n, int nrules) {
    return ({ CCArena* __cc_tpl_arena_260 = (a); CCString __cc_tpl_260 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_260, "static int ", 11, __cc_tpl_arena_260); cc__string_slot_push(&__cc_tpl_260, (n), __cc_tpl_arena_260); cc_string_push_buffer(&__cc_tpl_260, "__shape_end(", 12, __cc_tpl_arena_260); cc__string_slot_push(&__cc_tpl_260, (n), __cc_tpl_arena_260); cc_string_push_buffer(&__cc_tpl_260, "__ctx* c, size_t bi) {\n    ", 27, __cc_tpl_arena_260); cc__string_slot_push(&__cc_tpl_260, (n), __cc_tpl_arena_260); cc_string_push_buffer(&__cc_tpl_260, "Node* nd = c->tape + bi;\n    size_t span = c->total - bi;\n    int id = (int)(nd->meta & 0xFFu);\n    size_t vb = c->vbase[c->bdepth];\n    size_t vidx = vb;\n    CCShapeVal out;\n    size_t cnt = 0;\n    int pairs = id != 0xFF && id < ", 230, __cc_tpl_arena_260); cc__string_slot_push(&__cc_tpl_260, (nrules), __cc_tpl_arena_260); cc_string_push_buffer(&__cc_tpl_260, " && ", 4, __cc_tpl_arena_260); cc__string_slot_push(&__cc_tpl_260, (n), __cc_tpl_arena_260); cc_string_push_buffer(&__cc_tpl_260, "__dynobj[id];\n    { size_t t = 1; int odd = 0;\n      while (t < span) {\n          unsigned long long cm = nd[t].meta;\n          if (pairs && !odd && ((cm >> 8) & 1u)) pairs = 0;\n          odd ^= 1; cnt++;\n          t += ((cm >> 8) & 1u) ? (size_t)(cm >> 10) : 1;\n      }\n      if (odd) pairs = 0;   /* dangling key */\n    }\n    if (pairs) {\n        CCShapeObjD od;\n        if (!cc_shape_objd_begin(c->sb, &od, (unsigned)(cnt / 2))) return 0;\n        { size_t t = 1;\n          while (t < span) {\n              const ", 515, __cc_tpl_arena_260); cc__string_slot_push(&__cc_tpl_260, (n), __cc_tpl_arena_260); cc_string_push_buffer(&__cc_tpl_260, "Node* kn = nd + t;\n              t++;\n              { unsigned long long vm = nd[t].meta;\n                CCShapeVal* tgt = cc_shape_objd_slot(c->sb, &od,\n                    kn->u.bytes, (unsigned)(kn->meta >> 10));\n                if (!tgt) return 0;\n                if (!((vm >> 8) & 1u)) {\n                    if (!", 319, __cc_tpl_arena_260); cc__string_slot_push(&__cc_tpl_260, (n), __cc_tpl_arena_260); cc_string_push_buffer(&__cc_tpl_260, "__shape_leaf(c, nd + t, tgt)) return 0;\n                    t += 1;\n                } else {\n                    *tgt = c->vstack[vidx++];\n                    t += (size_t)(vm >> 10);\n                } }\n          } }\n        if (!cc_shape_objd_end(c->sb, &od, &out)) return 0;\n    } else {\n        CCShapeVal av;\n        CCShapeVal* items = cc_shape_arrd(c->sb, cnt, &av);\n        if (!items) return 0;\n        { size_t t = 1, i = 0;\n          while (t < span) {\n              unsigned long long cm = nd[t].meta;\n              if (!((cm >> 8) & 1u)) {\n                  if (!", 576, __cc_tpl_arena_260); cc__string_slot_push(&__cc_tpl_260, (n), __cc_tpl_arena_260); cc_string_push_buffer(&__cc_tpl_260, "__shape_leaf(c, nd + t, &items[i++])) return 0;\n                  t += 1;\n              } else {\n                  items[i++] = c->vstack[vidx++];\n                  t += (size_t)(cm >> 10);\n              }\n          } }\n        out = av;\n    }\n    /* consume children values, push own (anchored at the open) */\n    c->vsp = vb;\n    if (c->vsp == c->vcap && !", 358, __cc_tpl_arena_260); cc__string_slot_push(&__cc_tpl_260, (n), __cc_tpl_arena_260); cc_string_push_buffer(&__cc_tpl_260, "__vgrow(c)) return 0;\n    c->vanchor[c->vsp] = (const unsigned char*)nd->u.bytes;\n    c->vstack[c->vsp++] = out;\n    return 1;\n}\n", 129, __cc_tpl_arena_260); __cc_tpl_260; });
}

static inline CCString cc_gr_dom_entry_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_261 = (a); CCString __cc_tpl_261 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_261, "static __attribute__((unused)) int ", 35, __cc_tpl_arena_261); cc__string_slot_push(&__cc_tpl_261, (n), __cc_tpl_arena_261); cc_string_push_buffer(&__cc_tpl_261, "_dom(const char* s0, size_t n,\n        CCShapeReg* reg, CCArena* arena, CCShapeVal* out) {\n    const unsigned char* s = (const unsigned char*)s0;\n    ", 150, __cc_tpl_arena_261); cc__string_slot_push(&__cc_tpl_261, (n), __cc_tpl_arena_261); cc_string_push_buffer(&__cc_tpl_261, "__ctx c0;\n    size_t p = 0;\n    CCShapeB b;\n    c0.cap = 2048 + (n / 24);  /* ~real density; tgrow covers denser input */\n    c0.tape = (", 137, __cc_tpl_arena_261); cc__string_slot_push(&__cc_tpl_261, (n), __cc_tpl_arena_261); cc_string_push_buffer(&__cc_tpl_261, "Node*)cc_arena_alloc_local(arena, c0.cap * sizeof(", 50, __cc_tpl_arena_261); cc__string_slot_push(&__cc_tpl_261, (n), __cc_tpl_arena_261); cc_string_push_buffer(&__cc_tpl_261, "Node), _Alignof(", 16, __cc_tpl_arena_261); cc__string_slot_push(&__cc_tpl_261, (n), __cc_tpl_arena_261); cc_string_push_buffer(&__cc_tpl_261, "Node));\n    if (!c0.tape) return 0;\n    c0.total = 1; c0.bdepth = 0; c0.arena = arena;\n    c0.mat_ptr = 0; c0.mat_len = 0; c0.mat_cow = 0;\n    c0.tape[0].meta = 0x100u | 0xFFu;\n    c0.tape[0].u.bytes = (const char*)s;\n    cc_shape_build(&b, reg, arena);\n    c0.sb = &b;\n    c0.vcap = 256 + (n / 32);\n    c0.vstack = (CCShapeVal*)cc_arena_alloc_local(arena, c0.vcap * sizeof(CCShapeVal), 16);\n    c0.vanchor = (const unsigned char**)cc_arena_alloc_local(arena, c0.vcap * sizeof(void*), 16);\n    if (!c0.vstack || !c0.vanchor) return 0;\n    c0.vsp = 0;\n    c0.vbase[0] = 0;\n#if ", 576, __cc_tpl_arena_261); cc__string_slot_push(&__cc_tpl_261, (n), __cc_tpl_arena_261); cc_string_push_buffer(&__cc_tpl_261, "__ENTRY_PURE\n    if (!", 22, __cc_tpl_arena_261); cc__string_slot_push(&__cc_tpl_261, (n), __cc_tpl_arena_261); cc_string_push_buffer(&__cc_tpl_261, "__ENTRY_B((const unsigned char*)s, n, &p) || p != n) return 0;\n#else\n    if (!", 78, __cc_tpl_arena_261); cc__string_slot_push(&__cc_tpl_261, (n), __cc_tpl_arena_261); cc_string_push_buffer(&__cc_tpl_261, "__ENTRY_B(&c0, (const unsigned char*)s, n, &p) || p != n) return 0;\n#endif\n    c0.tape[0].meta |= ((unsigned long long)c0.total) << 10;\n    c0.bdepth = 0;\n    if (!", 164, __cc_tpl_arena_261); cc__string_slot_push(&__cc_tpl_261, (n), __cc_tpl_arena_261); cc_string_push_buffer(&__cc_tpl_261, "__shape_end(&c0, 0)) return 0;\n    *out = c0.vstack[0];\n    if (cc_shape_kind(out) == CC_SHAPE_ARR && out->u.arr->n == 1)\n        *out = out->u.arr->items[0];   /* single root: unwrap */\n    return 1;\n}\n", 203, __cc_tpl_arena_261); __cc_tpl_261; });
}

/* ---- rules-tier match entry ---- */
static inline CCString cc_gr_match_entry_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_262 = (a); CCString __cc_tpl_262 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_262, "static int ", 11, __cc_tpl_arena_262); cc__string_slot_push(&__cc_tpl_262, (n), __cc_tpl_arena_262); cc_string_push_buffer(&__cc_tpl_262, "_match(const char* s, size_t n) {\n    size_t p = 0;\n    if (!", 61, __cc_tpl_arena_262); cc__string_slot_push(&__cc_tpl_262, (n), __cc_tpl_arena_262); cc_string_push_buffer(&__cc_tpl_262, "__ENTRY_M((const unsigned char*)s, n, &p)) return 0;\n    return p == n;\n}\n", 74, __cc_tpl_arena_262); __cc_tpl_262; });
}
...
static inline CCString cc_gr_stream_face_text(CCArena* a, const char* n) {
    return ({ CCArena* __cc_tpl_arena_263 = (a); CCString __cc_tpl_263 = cc_string_new(); cc_string_push_buffer(&__cc_tpl_263, "static bool !>(CCError) ", 24, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "_try_read(const char* s0, size_t n,\n        size_t* pos, CCArena* arena, ", 73, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "* out) {\n    size_t p = *pos;\n    int cc_i0 = 0;\n    if (p >= n) return cc_ok(false);   /* clean end at frame boundary */\n    if (", 130, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "__fill((const unsigned char*)s0, n, &p, arena, out, &cc_i0, 0)) {\n        *pos = p;\n        return cc_ok(true);\n    }\n    if (cc_i0) return cc_err(CC_ERROR(CC_ERR_WOULD_BLOCK, \"", 177, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, ": incomplete frame\"));\n    return cc_err(CC_ERROR(CC_ERR_PARSE, \"", 65, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, ": malformed input\"));\n}\nstatic int ", 35, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "_read(const char* s0, size_t n, size_t* pos, CCArena* arena, ", 61, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "* out) {\n    int cc_i0 = 0;\n    return ", 39, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "__fill((const unsigned char*)s0, n, pos, arena, out, &cc_i0, 0);\n}\ntypedef struct ", 82, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "Reader {\n    const char* s; size_t n; size_t pos; CCArena* arena;\n} ", 68, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "Reader;\nstatic ", 15, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "Reader ", 7, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "_reader(const char* s, size_t n, CCArena* arena) {\n    ", 55, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "Reader r; r.s = s; r.n = n; r.pos = 0; r.arena = arena; return r;\n}\nstatic int ", 79, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "Reader_next(", 12, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "Reader* r, ", 11, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "* out) {\n    if (r->pos >= r->n) return 0;\n    int cc_i0 = 0;\n    return ", 73, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "__fill((const unsigned char*)r->s, r->n, &r->pos, r->arena, out, &cc_i0, 0);\n}\nstatic int ", 90, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "Reader_at_end(const ", 20, __cc_tpl_arena_263); cc__string_slot_push(&__cc_tpl_263, (n), __cc_tpl_arena_263); cc_string_push_buffer(&__cc_tpl_263, "Reader* r) { return r->pos == r->n; }\n", 38, __cc_tpl_arena_263); __cc_tpl_263; });
}

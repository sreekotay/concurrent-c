...
/* ============================================================================
 * Scheduler v3 seam (formerly fiber_sched_v3.c).
 * 
 * Work-pull implementations used by the V1 worker loop via the sched_boundary
 * facade (cc_sched_worker_next / cc_sched_worker_idle_probe). Under V2-default,
 * these are only reached if a V1 fiber runs — which no longer happens after
 * task.c routes every cc_fiber_spawn_task through sched_v2_spawn. Kept for
 * source-compat while the V1 worker loop is still linked in; will be deleted
 * with the rest of the V1 runtime in the follow-up API-rename pass.
 * ============================================================================ */

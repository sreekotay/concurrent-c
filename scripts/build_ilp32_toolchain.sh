...
# Named ILP32 volumes may still hold a host-synced Darwin libbearssl.a
# (rsync excludes build/ but does not --delete-excluded). That makes
# CC_ENABLE_TLS=1 then fails the ccc link with undefined br_*.

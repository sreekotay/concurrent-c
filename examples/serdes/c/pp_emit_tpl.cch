/* Typed emit templates — hole fill into CEmit (Phase 1 serdes write projection).
 *
 * Hole forms (v1):
...
static const char k_tpl_tu_prelude_c[] =
    "/* generated by examples/serdes/c shadow lowerer — not the production "
    "compiler */\n"
    "#include <stddef.h>\n"
    "#include <stdint.h>\n"
    "#include <stdlib.h>\n";

...
**Reading:** Both CC and Rust win by staying on their surface. **Prevented** = surface plus an enforceable rule (checker / schema). The only `still_expressible` entry is FFI wrong deleter — Rust parity.

...
| mitigated | 5 | CVE-2024-38561, CVE-2025-39945, CVE-2016-5180, SHAPE-integer-overflow, SHAPE-T9-raw-index-oob |
...
**Reading:** Checked index surface shipped (no debug/release split). Claim-A miss
left: bare `T*` channel handles. Rust-parity miss: FFI wrong deleter.
...
`checked-index-write` (Result `at`/`set`, all builds).

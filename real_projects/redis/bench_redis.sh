...
echo
echo "Planned role:"
echo "  - run phased benchmark suites against upstream Redis, redis_idiomatic, redis_hybrid, and eventually redis_cc"
...
echo "  cd \"$SCRIPT_DIR\""
echo "  make upstream redis_idiomatic redis_hybrid redis_cc"

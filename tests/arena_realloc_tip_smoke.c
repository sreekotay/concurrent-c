...
int main(void) {
    ...
    memset(p, 0xab, 64);
    off_after_first = cc_arena_slab_offset(a.a);
    ...
    if (cc_arena_slab_offset(a.a) != off_after_first + 64) {
    ...
    if (cc_arena_slab_offset(a.a) != (size_t)((unsigned char *)p - a.a->slab->base) + 32) {

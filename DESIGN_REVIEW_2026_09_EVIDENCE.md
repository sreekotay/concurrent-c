...
| A stage argument naming a body local fails in the host compiler (`'name' undeclared`): the exit's discharge is emitted outside the body scope | `studies/stage_name_detector/README.md` | defect (diagnostic) |

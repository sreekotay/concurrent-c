...
- [QuickJS](docs/quickjs.md) — in-process embed ([`qjsdemo.shcc`](examples/qjs/qjsdemo.shcc)); attach [bellard/quickjs](https://github.com/bellard/quickjs) or [quickjs-ng](https://github.com/quickjs-ng/quickjs), no child / napi / `require`

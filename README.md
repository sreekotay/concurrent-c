...
- [JS / Python interop](docs/js-py-modules.md) — host Python from CC ([`pydemo.shcc`](examples/py/pydemo.shcc)), or export one file → `.node` + `.abi3.so` (40-90ns); plus the process bridges below
